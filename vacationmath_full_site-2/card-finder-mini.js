...
(function () {
  ...
  function inject() {
    ...
    mount.innerHTML = ''
      ...
      +       '<p class="cfm-help">The three cards above are matched to this trip. If you want a shortlist built around your everyday spending and the perks you actually use, answer three quick questions — we score 15 cards and rank the top three for you. Honest math, no aspirational redemptions.</p>'
      +     '</div>'
      +     '<a href="card-finder.html" class="cfm-cta">Find my cards &rarr;</a>'
      +   '</div>'
      + '</aside>';
  }
