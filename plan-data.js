...
(function (global) {
  ...
  var TIER_DEFS = {
    ...
    stretch:{ label: "Splurge",   hint: "Nice-to-haves if you have room in the budget", styleShift: 1 }
  };
  ...
  var HOTEL_EXAMPLES = {
    ...
    cancun: {
      ...
      lux: H(
        ...
        "Le Blanc Spa Resort — Splurge only if you have room in the budget",
  ...
  var ACTIVITIES = {
    disney: A(
      ...
      [
        ...
        "Memory Maker / PhotoPass is in Splurge only if you have room in the budget (ticketed)"
      ]
    ),
    cruise: A(
      [
