...
(function () {
  ...
  const CALCULATORS = [
    { href: '/plan',         label: 'Vacation budget planner' },
  ...
  const PILLARS = [
    ...
    { href: '/guides#money-guides',                    label: 'Browse all 20 money guides' },
    { href: '/guides/disney',                          label: 'Disney World vacation cost guide' },
    { href: '/guides/anaheim',                         label: 'Disneyland vacation cost guide' },
    { href: '/guides/los_angeles',                     label: 'Los Angeles vacation cost guide' },
    { href: '/guides/nyc',                             label: 'New York City vacation cost guide' },
    { href: '/guides/vegas',                           label: 'Las Vegas vacation cost guide' },
    { href: '/guides/miami',                           label: 'Miami vacation cost guide' },
    { href: '/guides/san_francisco',                   label: 'San Francisco vacation cost guide' },
    { href: '/guides/chicago',                         label: 'Chicago vacation cost guide' },
    { href: '/guides/nola',                            label: 'New Orleans vacation cost guide' },
    { href: '/guides/philadelphia',                    label: 'Philadelphia vacation cost guide' },
    { href: '/guides/atlanta',                         label: 'Atlanta vacation cost guide' },
    { href: '/guides/paris',                           label: 'Paris vacation cost guide' },
    { href: '/guides/london',                          label: 'London vacation cost guide' },
    { href: '/guides/rome',                            label: 'Rome vacation cost guide' },
    { href: '/guides/tokyo',                           label: 'Tokyo vacation cost guide' },
    { href: '/guides/cancun',                          label: 'Cancún vacation cost guide' },
    { href: '/guides/oahu',                            label: 'Oahu vacation cost guide' },
    { href: '/guides/maui',                            label: 'Maui vacation cost guide' },
    { href: '/guides/cruise',                          label: 'Caribbean cruise vacation cost guide' },
    { href: '/guides/key_west',                        label: 'Key West vacation cost guide' },
...
<nav class="vm-nav" aria-label="Primary">
  <div class="vm-nav-inner">
    ...
    <ul id="vm-nav-links" class="vm-nav-links" data-open="false">
      ...
      <li><a href="${homeIsCurrent ? '#newsletter' : '/#newsletter'}" class="vm-nav-cta">Subscribe</a></li>
    </ul>
  </div>
</nav>`;
  }
  ...
  const RELATED_ARTICLES = {
    ...
    '/cruise': [
      { href: '/blog/hurricane-season-travel-insurance-2026', label: 'Hurricane season travel insurance 2026' },
      { href: '/blog/should-you-buy-travel-insurance-2026', label: 'Should you buy travel insurance 2026' },
      { href: '/guides/how-much-does-a-cruise-cost', label: 'How much does a cruise cost' },
    ...
    '/plan': [
      { href: '/guides#money-guides', label: 'Money guides' },
