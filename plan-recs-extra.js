/* =====================================================================
   ...
   Thickens Hotel / Food / Activities to 4–6 bullets per Budget/Mid-range/Splurge
...
(function (global) {
  ...
  function thickenHotels() {
    ...
    appendHotel("iceland", "lux", ["The Retreat at Blue Lagoon — soak + room, Splurge only", "Edition Reykjavík — 101 flagship if you skip the countryside"]);
  ...
  function thickenFood() {
    appendFood("disney", "budget", ["Refillable mug only if you will be on property most meals", "Skip a character breakfast on Budget — that is a ticketed meal, not breakfast"]);
  ...
  function installFullRecs() {
    P.HOTEL_EXAMPLES["anaheim"] = {
      budget: { why: "Harbor Blvd / Downtown Disney walking. A cheap LA room plus a 90-minute transfer is not Budget.", picks: [
        ...
        "Pixar Place is mid; Budget stays off-property and groceries breakfast"
      ] },
    ...
    P.FOOD_PICKS["anaheim"] = {
      ...
      budget: [
        ...
        "Dinner: Harbor Blvd casual or Downtown Disney QS — skip character dining on Budget",
    ...
    P.ACTIVITIES["anaheim"] = {
      budget: [
        ...
        "Rope drop + mobile order; skip Lightning Lane on Budget (free tactic)",
    ...
    P.ACTIVITIES["key_west"] = {
      budget: [
        "Mallory sunset from the sidewalk — skip a paid pier ticket on Budget (free)",
        ...
        "Skip a parasail upsell on Budget"
      ],
      mid: [
    ...
    P.FOOD_PICKS["philadelphia"] = {
      ...
      budget: [
        ...
        "Skip three $28 Rittenhouse salads on Budget"
      ],
      mid: [
    ...
    P.ACTIVITIES["philadelphia"] = {
      budget: [
        ...
        "Skip a carriage loop on Budget"
      ],
      mid: [
    ...
    P.FOOD_PICKS["atlanta"] = {
      ...
      budget: [
        ...
        "Dinner: Mary Mac’s Tea Room — meat-and-three, the Budget classic",
        "Varasano’s or a neighborhood pizza if you skip the tourist row",
        "Skip a Buckhead steakhouse on Budget"
      ],
      mid: [
        "Breakfast: café most mornings",
    ...
    P.HOTEL_EXAMPLES["dallas"] = {
      budget: { why: "Downtown / Deep Ellum / Bishop Arts — pick one neighborhood. DFW-adjacent is a car tax.", picks: [
        ...
        "Skip a Las Colinas / Galleria cloverleaf on Budget"
      ] },
    ...
    P.HOTEL_EXAMPLES["houston"] = {
      budget: { why: "Museum District / Midtown / Montrose. IAH lodging is a transfer, not a trip.", picks: [
        ...
        "Skip an Energy Corridor cloverleaf on Budget"
      ] },
    ...
    P.ACTIVITIES["houston"] = {
      budget: [
        ...
        "Space Center Houston is a half-day and a transfer — not Budget default (ticketed)",
        "Skip a hop-on bus"
      ],
      mid: [
    ...
    P.ACTIVITIES["san_antonio"] = {
      budget: [
        ...
        "Skip SeaWorld / Fiesta Texas on Budget unless that is the trip (ticketed)",
    ...
    P.FOOD_PICKS["palm_springs"] = {
      ...
      budget: [
        "Breakfast: Cheeky’s-adjacent wait is mid; Budget is a bakery or taco",
        "Lunch: taco shop or a date shake — not a resort café",
        "Dinner: Downtown Palm Canyon casual",
        "Skip a hotel restaurant on Budget",
    ...
    P.ACTIVITIES["palm_springs"] = {
      budget: [
        ...
        "Aerial Tramway is a ticket; Budget can skip it (ticketed)",
        "Skip a pool-day cabana on Budget",
    ...
    P.FOOD_PICKS["lake_tahoe"] = {
      ...
      budget: [
        ...
        "Skip a lakeview steakhouse on Budget",
    ...
    P.HOTEL_EXAMPLES["napa"] = {
      budget: { why: "Town inn in Napa or Sonoma. A tasting-room hotel plus a parked car is a tax.", picks: [
        ...
        "Yountville is mid-plus; Budget stays in town"
      ] },
    ...
    P.ACTIVITIES["monterey"] = {
      budget: [
        ...
        "17-Mile Drive has a fee — Budget can skip and use public pull-offs (ticketed / free)",
        "Skip a whale-watch upsell on Budget if the water is rough (tour)",
    ...
    P.HOTEL_EXAMPLES["destin_30a"] = {
      ...
      mid: { why: "Walk-to-beach midrise or a 30A condo in one town.", picks: [
        ...
        "The Henderson is Splurge; mid is a renovated condo a block off",
    ...
    P.ACTIVITIES["destin_30a"] = {
      budget: [
        ...
        "Skip a dolphin-cruise upsell on Budget (tour)",
    ...
    P.HOTEL_EXAMPLES["outer_banks"] = {
      budget: { why: "House week, not a hotel-strip week. Nags Head / Kill Devil Hills is the Budget corridor.", picks: [
        "Nags Head or Kill Devil Hills motel / 2-star — walk or a short drive to the sand",
        "A house share with a kitchen — the Budget product if the party will cook",
        "Kitty Hawk value inn — grocery the first hour",
        "Skip a Corolla oceanfront on Budget; the drive is longer and the rate is not",
    ...
    P.ACTIVITIES["outer_banks"] = {
      budget: [
        ...
        "Skip a wild-horse tour on Budget if you can see them from a public access (tour / free)",
        "Grocery picnic (cheap)"
      ],
      mid: [
    ...
    P.HOTEL_EXAMPLES["grand_canyon"] = {
      budget: { why: "South Rim in-park or Tusayan. Flagstaff is a commute, not Budget lodging.", picks: [
    ...
    P.ACTIVITIES["grand_canyon"] = {
      budget: [
        ...
        "Skip a helicopter on Budget (tour)",
    ...
    P.HOTEL_EXAMPLES["jackson_hole"] = {
      budget: { why: "Jackson town or Teton Village. A cheap Idaho Falls room is a different drive.", picks: [
        "The Hostel (Teton Village) or a Jackson 2-star — ski-season Budget",
        "49’er Inn or a Motel 6-class in town — grocery the first hour",
        "A cabin court on the edge of town if you have a car",
        "Skip a ski-in marketing rate on Budget; the bus exists",
    ...
    P.FOOD_PICKS["jackson_hole"] = {
      ...
      budget: [
        ...
        "Skip a village steakhouse on Budget",
    ...
    P.FOOD_PICKS["phoenix"] = {
      ...
      budget: [
        ...
        "Skip a Scottsdale steakhouse on a Phoenix Budget week",
        "Grocery a trail-day picnic"
      ],
      mid: [
        "Breakfast: café",
    ...
    P.ACTIVITIES["phoenix"] = {
      budget: [
        ...
        "Skip a hot-air balloon on Budget (tour)",
    ...
    P.FOOD_PICKS["memphis"] = {
      ...
      budget: [
        ...
        "Skip a Beale cover-charge dinner on Budget",
    ...
    P.ACTIVITIES["memphis"] = {
      budget: [
        ...
        "Skip Graceland on Budget unless that is the trip (ticketed)",
        "Trolley hop (cheap)"
      ],
      mid: [
    ...
    P.HOTEL_EXAMPLES["portland_me"] = {
      budget: { why: "Old Port walking. This is not Portland, Oregon.", picks: [
        ...
        "The Press Hotel is mid; Budget stays a block off the cobblestones"
      ] },
    ...
    P.HOTEL_EXAMPLES["bar_harbor"] = {
      budget: { why: "Bar Harbor village walking. A cheap Bangor room is a dawn drive, not Budget lodging.", picks: [
        ...
        "Bar Harbor Inn is mid; Budget stays a few blocks uphill"
      ] },
    ...
    P.FOOD_PICKS["bar_harbor"] = {
      ...
      budget: [
        ...
        "Skip a dinner cruise on Budget",
    ...
    P.FOOD_PICKS["santa_fe"] = {
      ...
      budget: [
        ...
        "Skip a Canyon Road tourist menu on Budget",
    ...
    P.ACTIVITIES["turks_caicos"] = {
      budget: [
        ...
        "Skip a dolphin upsell on Budget",
    ...
    P.ACTIVITIES["aruba"] = {
      budget: [
        ...
        "Skip the first catamaran on Budget",
    ...
    P.ACTIVITIES["bahamas"] = {
      budget: [
        ...
        "Skip a jet-ski upsell on Budget",
    ...
    P.HOTEL_EXAMPLES["cabo"] = {
      budget: { why: "Cabo San Lucas town or a Corridor value. Medano beach is the walkable product.", picks: [
        ...
        "Skip a sunset-cruise hotel on Budget",
        "Confirm the transfer",
    ...
    P.FOOD_PICKS["cabo"] = {
      ...
      budget: [
        ...
        "Skip the marina tourist row on Budget",
    ...
    P.HOTEL_EXAMPLES["prague"] = {
      budget: { why: "Old Town adjacent on a tram, not a castle-view tax.", picks: [
        ...
        "Skip a river-cruise hotel on Budget",
        "Pack light — stairs"
      ] },
    ...
    P.FOOD_PICKS["greece_athens"] = {
      ...
      budget: [
        ...
        "Skip a rooftop minimum on Budget",
        "Grocery a picnic"
      ],
      mid: [
        "Breakfast: café",
    ...
    P.ACTIVITIES["greece_athens"] = {
      budget: [
        ...
        "Skip a second hill ticket on Budget",
    ...
    P.HOTEL_EXAMPLES["edinburgh"] = {
      budget: { why: "Old Town or Leith. A cheap airport room is a tram tax.", picks: [
        ...
        "Skip a castle-view tax on Budget",
    ...
    P.ACTIVITIES["edinburgh"] = {
      budget: [
        ...
        "Castle is a ticket — Budget can skip the interior (ticketed)",
        "A free museum — National Museum (free)",
        "Skip a ghost tour on Budget",
    ...
    P.HOTEL_EXAMPLES["dublin"] = {
      budget: { why: "Temple Bar-adjacent is a tax. Stay in the Liberties or near a Luas stop.", picks: [
        ...
        "Skip a Temple Bar balcony on Budget",
    ...
    P.FOOD_PICKS["dublin"] = {
      ...
      budget: [
        ...
        "Skip Temple Bar dinner on Budget",
        "Grocery a picnic"
      ],
      mid: [
        "Breakfast: café",
    ...
    P.HOTEL_EXAMPLES["santorini"] = {
      budget: { why: "Fira or a bus-linked village. Oia caldera suites are Splurge.", picks: [
        "Fira hostel-plus or a 2-star off the caldera rim",
        "A Kamari 2-star if you want a beach bus",
        "Skip an Oia cave suite on Budget",
    ...
    P.FOOD_PICKS["santorini"] = {
      ...
      budget: [
        ...
        "Skip an Oia sunset restaurant on Budget",
        "Grocery water"
      ],
      mid: [
        "Breakfast: café",
    ...
    P.HOTEL_EXAMPLES["kauai"] = {
      budget: { why: "Condo in Kapaa / Lihue or a South Shore studio. The kitchen is the Budget product.", picks: [
        ...
        "Skip a North Shore hotel on Budget unless that is the point",
    ...
    P.ACTIVITIES["kauai"] = {
      budget: [
        ...
        "Skip a helicopter on Budget (tour)",
        "Grocery picnic",
        "Kalalau is not a Budget day hike"
      ],
      mid: [
    ...
    P.HOTEL_EXAMPLES["hawaii_big_island"] = {
      budget: { why: "Kona condo or a Hilo 2-star if volcano days are the point. Two sides is two climates.", picks: [
        ...
        "Skip a resort breakfast hotel on Budget",
    ...
    P.FOOD_PICKS["denver"] = {
      ...
      budget: [
        ...
        "Dinner: RiNo casual",
        "Skip Larimer tourist menus on Budget",
    ...
    P.ACTIVITIES["denver"] = {
      budget: [
        ...
        "Skip a mountain tour on Budget if you came for the city",
        "RiNo murals (free)",
        "Light rail day pass"
      ],
      mid: [
    ...
    P.HOTEL_EXAMPLES["charleston"] = {
      budget: { why: "Upper King or a South of Broad-adjacent 2-star. Peninsula walking.", picks: [
        ...
        "Skip a Mount Pleasant cloverleaf on Budget",
      ...
      mid: { why: "French Quarter or Upper King 3–4 star.", picks: [
        ...
        "Zero George is Splurge-adjacent; mid is a 3–4 star on the peninsula",
    ...
    P.FOOD_PICKS["charleston"] = {
      ...
      budget: [
        ...
        "Skip a carriage-loop restaurant on Budget",
        "Grocery a picnic"
      ],
      mid: [
        "Breakfast: café",
    ...
    P.HOTEL_EXAMPLES["savannah"] = {
      budget: { why: "Historic District walking. A cheap airport room is a rideshare habit.", picks: [
        ...
        "Skip a Gateway cloverleaf on Budget",
        "Squares are the product"
      ] },
      mid: { why: "A square-adjacent 3–4 star.", picks: [
        "The Alida or a river-adjacent mid",
        "Perry Lane Hotel is Splurge-adjacent; mid is a square 3–4 star",
    ...
    P.FOOD_PICKS["savannah"] = {
      ...
      budget: [
        ...
        "Skip River Street dinner on Budget",
        "Grocery a picnic"
      ],
      mid: [
        "Breakfast: café",
    ...
    P.FOOD_PICKS["asheville"] = {
      ...
      budget: [
        ...
        "Skip a Biltmore restaurant on Budget",
    ...
    P.ACTIVITIES["asheville"] = {
      budget: [
        ...
        "Skip Biltmore on Budget unless that is the trip (ticketed)",
    ...
    P.ACTIVITIES["national_parks_southwest"] = {
      budget: [
        ...
        "Skip a second park on Budget if the drive is the day",
        "A visitor-center hour",
        "Sunrise if you slept close",
        "Lottery hikes are not a sure Budget plan"
      ],
      mid: [
    ...
    P.HOTEL_EXAMPLES["smoky_mountains"] = {
      budget: { why: "Gatlinburg edge or a Pigeon Forge value. The park is free; the strip is not.", picks: [
        ...
        "Skip a downtown balcony on Budget",
    ...
    P.HOTEL_EXAMPLES["austin"] = {
      budget: { why: "Walkable Downtown / East Austin. A cheap airport room is a rideshare habit.", picks: [
        ...
        "Skip a Domain cloverleaf on Budget",
    ...
    P.HOTEL_EXAMPLES["nashville"] = {
      budget: { why: "Walkable Downtown-adjacent or East Nashville. Broadway balconies are a tax.", picks: [
        ...
        "Skip a Broadway balcony on Budget",
    ...
    P.FOOD_PICKS["nashville"] = {
      ...
      budget: [
        ...
        "Skip Broadway dinner on Budget",
        "Grocery a picnic"
      ],
      mid: [
        "Breakfast: café",
    ...
    P.FOOD_PICKS["scottsdale"] = {
      ...
      budget: [
        ...
        "Skip a resort steakhouse on Budget",
    ...
    P.HOTEL_EXAMPLES["seattle"] = {
      budget: { why: "Walkable Belltown / Capitol Hill / Pioneer Square. A cheap airport room is a Link tax.", picks: [
        ...
        "Skip a Tukwila cloverleaf on Budget",
    ...
    P.FOOD_PICKS["washington_dc"] = {
      ...
      budget: [
        ...
        "Dinner: a neighborhood casual",
        "Skip a Capitol Hill steakhouse on Budget",
    ...
    P.HOTEL_EXAMPLES["costa_rica"] = {
      budget: { why: "Town guesthouse in La Fortuna or Manuel Antonio. Two bases need a transfer night.", picks: [
        ...
        "Skip a volcano-view suite on Budget",
        "Confirm the shuttle",
    ...
    P.HOTEL_EXAMPLES["belize"] = {
      budget: { why: "Caye Caulker 2-star or a San Pedro value. Mainland ruins need a night.", picks: [
        ...
        "Skip an overwater bungalow on Budget",
    ...
    P.FOOD_PICKS["guatemala"] = {
      ...
      budget: [
        ...
        "Skip the first courtyard on Budget",
    ...
    P.ACTIVITIES["guatemala"] = {
      budget: [
        ...
        "Skip Pacaya on Budget if weather is junk",
        "A market hour",
        "Altitude slack"
      ],
      mid: [
    ...
    P.HOTEL_EXAMPLES["peru"] = {
      budget: { why: "Cusco guesthouse. Machu Picchu is a ticketed day with a train line.", picks: [
        ...
        "Skip an Aguas Calientes suite on Budget",
    ...
    P.FOOD_PICKS["peru"] = {
      ...
      budget: [
        ...
        "Skip guinea pig on Budget if you do not want it",
    ...
    P.HOTEL_EXAMPLES["buenos_aires"] = {
      budget: { why: "Palermo or San Telmo 2-star. Subte, not a tourist taxi loop.", picks: [
        ...
        "Skip a Recoleta palace on Budget",
        "Subte day pass",
    ...
    P.FOOD_PICKS["buenos_aires"] = {
      ...
      budget: [
        ...
        "Skip a Puerto Madero steak on Budget",
        "Grocery a picnic"
      ],
      mid: [
        "Breakfast: café",
    ...
    P.HOTEL_EXAMPLES["colombia"] = {
      budget: { why: "Getsemaní guesthouse. The walled city is the walk.", picks: [
        ...
        "Skip a Bocagrande tower on Budget unless the beach is the point",
        "Heat is free",
        "Taxis have apps"
      ] },
    ...
    P.HOTEL_EXAMPLES["vietnam"] = {
      budget: { why: "Old Quarter guesthouse, then a Hoi An 2-star. Two cities need a night.", picks: [
        ...
        "Skip a Halong overnight on Budget if seas are junk",
    ...
    P.HOTEL_EXAMPLES["australia"] = {
      budget: { why: "Hostel-plus or a 3-star on a train. Long-haul already spent the luxury.", picks: [
        ...
        "Skip a Opera House-view suite on Budget",
        "Opal card",
    ...
    P.HOTEL_EXAMPLES["new_zealand"] = {
      budget: { why: "Queenstown hostel-plus or a 3-star. Adventures are add-ons.", picks: [
        ...
        "Skip a lakefront suite on Budget",
    ...
    P.HOTEL_EXAMPLES["morocco"] = {
      budget: { why: "Medina riad or a 3-star on a tram. Day tours beat a palace room you do not need.", picks: [
        ...
        "Skip a palmeraie resort on Budget",
    ...
    P.HOTEL_EXAMPLES["south_africa"] = {
      budget: { why: "City Bowl or a waterfront 3-star. Safari is a different lodging line.", picks: [
        ...
        "Skip a waterfront suite on Budget",
    ...
    P.HOTEL_EXAMPLES["egypt"] = {
      budget: { why: "Downtown or Zamalek 3-star. Nile cruises are a different lodging line.", picks: [
        ...
        "A Zamalek 3-star",
        "Skip a pyramid-view suite on Budget",
        "Uber / Careem",
    ...
    P.FOOD_PICKS["egypt"] = {
      ...
      budget: [
        ...
        "Lunch: koshary",
        "Dinner: a grill",
        "Skip the hotel buffet on Budget",
        "Buy water in a shop"
      ],
      mid: [
        "Breakfast: café",
    ...
    P.ACTIVITIES["egypt"] = {
      budget: [
        ...
        "Skip a second pyramid complex on Budget",
        "A Nile walk",
    ...
    P.FOOD_PICKS["alaska_cruise"] = {
      ...
      budget: [
        ...
        "Dinner: main dining every night on Budget",
    ...
    P.HOTEL_EXAMPLES["st_lucia"] = {
      budget: { why: "A value AI in the north or a Soufrière 3-star. Transfers are long.", picks: [
        ...
        "Skip a piton-view suite on Budget",
    ...
    P.HOTEL_EXAMPLES["puerto_rico"] = {
      budget: { why: "Old San Juan guesthouse or a Condado 2-star. No passport for US citizens.", picks: [
        ...
        "Skip a resort casino on Budget",
    ...
    P.FOOD_PICKS["puerto_rico"] = {
      ...
      budget: [
        ...
        "Skip a cruise-ship menu on Budget",
        "Piragua once"
      ],
      mid: [
        "Breakfast: café",
    ...
    P.HOTEL_EXAMPLES["singapore"] = {
      budget: { why: "A hostel-plus or a 3-star on the MRT. Hawker food is the trip.", picks: [
        ...
        "Skip a Marina Bay suite on Budget",
        "EZ-Link",
        "Airport is a train"
      ] },
    ...
    P.HOTEL_EXAMPLES["south_korea"] = {
      budget: { why: "A business hotel next to a subway. Convenience stores are the Budget breakfast.", picks: [
        "A hotel near Hongdae or Jongno station",
        "A hostel-plus in Seoul",
        "Skip a palace-view suite on Budget",
        "T-money",
    ...
    P.HOTEL_EXAMPLES["florence"] = {
      budget: { why: "Oltrarno or a Santa Maria Novella 2-star. Duomo-view rooms are a tax.", picks: [
        ...
        "Skip a Duomo-view suite on Budget",
        "Walk, not taxis",
        "Pack light — stairs"
      ] },
    ...
    P.HOTEL_EXAMPLES["amalfi"] = {
      budget: { why: "A Sorrento 2-star or a Salerno crash pad. Cliff suites are Splurge.", picks: [
    ...
    P.HOTEL_EXAMPLES["switzerland"] = {
      budget: { why: "A hostel or a 3-star on a rail line. The pass is a math problem, not a souvenir.", picks: [
        ...
        "Skip a Jungfrau suite on Budget",
        "Grocery the first hour",
    ...
    P.FOOD_PICKS["switzerland"] = {
      ...
      budget: [
        ...
        "Skip hotel half-board on Budget",
        "Coop picnic"
      ],
      mid: [
        "Breakfast: café",
    ...
    P.HOTEL_EXAMPLES["ecuador_galapagos"] = {
      budget: { why: "A budget boat or a Santa Cruz guesthouse. The park fee is a line.", picks: [
        ...
        "Park fee + flight are the real Budget lines",
        "Skip a last-minute suite on Budget",
    ...
    P.ACTIVITIES["ecuador_galapagos"] = {
      budget: [
        ...
        "Skip a second extra dive on Budget",
    ...
    P.FOOD_PICKS["kenya_safari"] = {
      ...
      budget: [
        ...
        "Skip a hotel steak in town on Budget",
    ...
    P.HOTEL_EXAMPLES["portugal_algarve"] = {
      budget: { why: "A Lagos or Tavira 2-star. Cliff hotels are Splurge.", picks: [
    ...
    P.HOTEL_EXAMPLES["taiwan"] = {
      budget: { why: "A business hotel next to a MRT. Night markets are the dinner plan.", picks: [
        ...
        "Skip a Taipei 101 suite on Budget",
        "EasyCard",
    ...
    P.HOTEL_EXAMPLES["budapest"] = {
      budget: { why: "A District VII hostel-plus or a 2-star on a tram.", picks: [
        ...
        "Skip a Parliament-view suite on Budget",
        "Pack light — stairs",
    ...
    P.HOTEL_EXAMPLES["stockholm"] = {
      budget: { why: "A hostel-plus or a 3-star on the Tunnelbana.", picks: [
        ...
        "Skip a Gamla Stan suite on Budget",
    ...
    P.FOOD_PICKS["stockholm"] = {
      ...
      budget: [
        ...
        "Skip Gamla Stan dinner on Budget",
        "Grocery a picnic"
      ],
      mid: [
        "Breakfast: café",
    ...
    P.HOTEL_EXAMPLES["mexico_oaxaca"] = {
      budget: { why: "A centro guesthouse. Mole and mezcal are the trip.", picks: [
        ...
        "A 2-star courtyard",
        "Skip a rooftop suite on Budget",
        "Walk the centro",
        "Altitude is real"
      ] },
    ...
    P.HOTEL_EXAMPLES["brazil_rio"] = {
      budget: { why: "A hostel-plus in Botafogo or a Copacabana 2-star off the first row.", picks: [
        ...
        "Skip an Ipanema suite on Budget",
        "Metro exists",
        "Nights have a plan"
      ] },
    ...
    P.ACTIVITIES["brazil_rio"] = {
      budget: [
        ...
        "One viewpoint — Sugarloaf or Christ, not both on Budget (ticketed)",
        "Skip a party-van on Budget",
        "A neighborhood walk",
        "Nights: have a route"
      ],
      mid: [
    ...
    P.HOTEL_EXAMPLES["philippines_palawan"] = {
      budget: { why: "An El Nido guesthouse. Island-hops are the product.", picks: [
        ...
        "Skip an overwater suite on Budget",
    ...
    P.ACTIVITIES["cambodia"] = {
      budget: [
        ...
        "Skip a second sunrise on Budget",
        "A town walk",
        "Heat slack midday",
    ...
    P.HOTEL_EXAMPLES["portugal_porto"] = {
      budget: { why: "A Ribeira-adjacent 2-star or a Cedofeita guesthouse. Hills and tiles.", picks: [
        ...
        "Skip a river-view suite on Budget",
        "Pack light — stairs",
    ...
    P.HOTEL_EXAMPLES["spain_seville"] = {
      budget: { why: "A centro 2-star on a tram. July heat is the discount.", picks: [
        ...
        "Skip a cathedral-view suite on Budget",
    ...
    P.ACTIVITIES["spain_seville"] = {
      budget: [
        "A centro walk (free)",
        "One interior — Alcázar or cathedral, not both on Budget (ticketed)",
        "Skip a hop-on bus",
        "A plaza hour",
        "Heat slack midday"
      ],
    ...
    P.HOTEL_EXAMPLES["nepal"] = {
      budget: { why: "A Thamel guesthouse. Trekking is a different lodging line.", picks: [
        ...
        "A 2-star courtyard",
        "Skip a mountain-view suite on Budget",
    ...
    P.HOTEL_EXAMPLES["italy_sicily"] = {
      budget: { why: "A Palermo or Catania 2-star. The island is a transfer plan.", picks: [
        ...
        "Skip a Taormina suite on Budget",
    ...
    P.ACTIVITIES["peru_lima"] = {
      budget: [
        "Malecón walk (free)",
        "One museum (ticketed / cheap)",
        "Skip a second tasting on Budget",
        "A Barranco evening",
        "Fog slack"
      ],
      mid: [
  ...
  function installActsOnly() {
    P.ACTIVITIES["punta_cana"] = {
      budget: [
        ...
        "Skip a dock catamaran on Budget",
  ...
  function patchUniques() {
    ...
    appendHotel("lisbon", "budget", ["A Graça or Alfama walk-up with a grocery on the block", "Skip a miradouro hotel on Budget — the view is free from the street"]);
    appendHotel("lisbon", "mid", ["A Príncipe Real 3–4 star — walk downhill to dinner", "One neighborhood. Do not change hills nightly"]);
    appendHotel("barcelona", "budget", ["A Gràcia 2-star on a Metro line — restaurants on the block", "Skip Las Ramblas addresses on Budget"]);
    appendHotel("barcelona", "mid", ["An Eixample 3–4 star near Passeig de Gràcia Metro", "One neighborhood — Born or Eixample, not both"]);
    appendHotel("amsterdam", "budget", ["A Jordaan-adjacent 2-star — pack light, stairs are the elevator", "Skip a canal-house rate on Budget if a tram 3-star is cheaper"]);
    ...
    appendHotel("bali", "budget", ["A Canggu homestay — walk to a warung, scooter for the beach", "Skip Seminyak rates on Budget"]);
