...
(function (global) {
  ...
  function thickenHotels() {
    ...
    appendHotel("nyc", "lux", ["The Greenwich Hotel or The Public class — Downtown, only if you're spending more", "One flagship. A second Midtown suite is not Stretch, it is a mistake"]);
    ...
    appendHotel("punta_cana", "lux", ["Eden Roc at Cap Cana — Stretch villa class", "Sanctuary Cap Cana — same area, not a second island hop"]);
    ...
    appendHotel("nola", "lux", ["Hotel Monteleone — Quarter flagship, only if you're spending more", "Maison de la Luz or The Chloe — design Stretch"]);
    ...
    appendHotel("dubai", "lux", ["Atlantis The Palm — Palm Stretch, kids assumed", "Burj Al Arab or One&Only — name-brand only if you're spending more"]);
  }
  ...
  function thickenFood() {
    ...
    appendFood("cruise", "lux", ["Chef’s table only if you're spending more", "Unlimited drinks are in Stretch — still run the break-even"]);
    ...
    appendFood("san_diego", "lux", ["Addison (Del Mar) only if you're spending more", "One splurge; Stretch does not require a steak at noon"]);
    ...
    appendFood("thailand", "lux", ["A named riverside or tasting only if you're spending more", "One splurge; Stretch does not require a mall"]);
  ...
  function installFullRecs() {
    ...
    P.HOTEL_EXAMPLES["philadelphia"] = {
      ...
      lux: { why: "Rittenhouse or Parkway flagship. Hotel tax is already in the plan.", picks: [
        ...
        "The Bellevue or Fitler Club — Stretch if you have room in the budget",
    ...
    P.FOOD_PICKS["dallas"] = {
      ...
      budget: [
        ...
        "Pecan Lodge only if you're spending more; Lean is a taco plate",
    ...
    P.HOTEL_EXAMPLES["san_antonio"] = {
      ...
      lux: { why: "Historic flagship. Fiesta week is not the value window.", picks: [
        ...
        "Hotel Emma Stretch suite if you have room in the budget for the jump",
    ...
    P.HOTEL_EXAMPLES["destin_30a"] = {
      budget: { why: "Destin condo or a 30A town you can walk. Harbor-view hotels are a parking tax if you came for the sand.", picks: [
        "Destin 1-bedroom condo off 98 — kitchen is the cheaper way",
    ...
    P.HOTEL_EXAMPLES["outer_banks"] = {
      budget: { why: "House week, not a hotel-strip week. Nags Head / Kill Devil Hills is the Lean corridor.", picks: [
        ...
        "A house share with a kitchen — the cheaper way if the party will cook",
    ...
    P.FOOD_PICKS["portland_me"] = {
      ...
      budget: [
        ...
        "Lunch: Eventide only if you're spending more; Lean is a market or a roll shack",
    ...
    P.HOTEL_EXAMPLES["kauai"] = {
      budget: { why: "Condo in Kapaa / Lihue or a South Shore studio. The kitchen is the cheaper way.", picks: [
    ...
    P.ACTIVITIES["yellowstone"] = {
      ...
      mid: [
        "Two citys on different days (park entry)",
    ...
    P.FOOD_PICKS["austin"] = {
      ...
      budget: [
        ...
        "Lunch: a food truck",
        "Dinner: one barbecue plate — Franklin only if you're spending more; Lean is a neighborhood shop",
    ...
    P.HOTEL_EXAMPLES["boston"] = {
      budget: { why: "Walkable Back Bay / North End-adjacent / Cambridge on the T. Logan hotels are a water-taxi tax.", picks: [
        ...
        "Skip a Seaport convention rate on Lean unless you have room in the budget",
    ...
    P.HOTEL_EXAMPLES["washington_dc"] = {
      budget: { why: "Walkable National Mall-adjacent or a Metro neighborhood. Airport lodging is a taxi tax.", picks: [
        ...
        "Skip a Crystal City cloverleaf on Lean unless you have room in the budget for the Metro",
    ...
    P.HOTEL_EXAMPLES["colombia"] = {
      ...
      lux: { why: "A design casa only if you're spending more.", picks: [
        "A restored Stretch casa",
        "A beach Stretch only if you're spending more",
        "One property",
    ...
    P.ACTIVITIES["vietnam"] = {
      budget: [
        ...
        "Skip a junk on Lean if the budget is tight",
        "A lake loop",
    ...
    P.HOTEL_EXAMPLES["egypt"] = {
      ...
      lux: { why: "A palace only if you're spending more.", picks: [
        "A Nile Stretch",
        "A cruise Stretch only if you're spending more",
        "One property",
    ...
    P.HOTEL_EXAMPLES["us_virgin_islands"] = {
      ...
      lux: { why: "A flagship only if you're spending more.", picks: [
        "A Caneel only if you're spending more / a Stretch resort",
        "One island",
    ...
    P.HOTEL_EXAMPLES["croatia"] = {
      ...
      lux: { why: "A flagship only if you're spending more.", picks: [
        ...
        "An island Stretch only if you're spending more",
        "One property",
        "Do not also buy every island as a sure day",
        "Cruise mornings are a crowd tax"
      ] }
    ...
    P.ACTIVITIES["switzerland"] = {
      budget: [
        ...
        "Skip Jungfraujoch on Lean if the budget is tight",
        "A lake hour",
    ...
    P.ACTIVITIES["portugal_algarve"] = {
      budget: [
        ...
        "Skip a grotto-boat on Lean if the budget is tight",
    ...
    P.ACTIVITIES["copenhagen"] = {
      budget: [
        ...
        "Skip Tivoli on Lean if the budget is tight",
        "A neighborhood walk",
        "Metro pass"
      ],
      mid: [
    ...
    P.ACTIVITIES["panama"] = {
      budget: [
        "Casco walk (free)",
        "One museum (ticketed / cheap)",
        "Skip a canal tour on Lean if the budget is tight",
    ...
    P.HOTEL_EXAMPLES["jordan"] = {
      ...
      lux: { why: "A Stretch camp only if you're spending more.", picks: [
    ...
    P.ACTIVITIES["norway_fjords"] = {
      budget: [
        ...
        "Skip a second fjord on Lean if the budget is tight",
        "Layers are the activity",
        "Weather slack"
      ],
      mid: [
    ...
    P.ACTIVITIES["tanzania_zanzibar"] = {
      budget: [
        ...
        "One beach day (free)",
        "Skip a spice tour on Lean if the budget is tight",
    ...
    P.ACTIVITIES["nepal"] = {
      budget: [
        ...
        "One stupa (cheap)",
        "Skip a short-trek upsell on Lean if the budget is tight",
        "A garden only if you're spending more",
        "Altitude slack"
      ],
      mid: [
    ...
    P.ACTIVITIES["indonesia_lombok"] = {
      budget: [
        "A beach day (free)",
        "Skip a Rinjani upsell on Lean if the budget is tight",
        "A waterfall only if you're spending more",
    ...
    P.ACTIVITIES["italy_sicily"] = {
      budget: [
        ...
        "One ruin — skip a stack (ticketed)",
        "Skip Etna on Lean if the budget is tight",
  ...
  function installActsOnly() {
    ...
    P.ACTIVITIES["iceland"] = {
      budget: [
        "A 101 walk (free)",
        "A pool hour (cheap)",
        "Skip the Blue Lagoon on Lean if the budget is tight",
  ...
  function patchUniques() {
    ...
    appendHotel("thailand", "budget", ["A Khao San-adjacent guesthouse only as a crash pad — Silom / old city is quieter", "Fan room + a stall downstairs is the cheaper way"]);
  ...
  function rebalanceHotels() {
    ...
    replaceHotel("los_angeles", "lux", ["JW Marriott Los Angeles L.A. LIVE — Stretch default for Marriott points", "Conrad Los Angeles — Grand LA, DTLA flagship", "The Ritz-Carlton Los Angeles — L.A. LIVE tower, only if you're spending more", "Waldorf Astoria Beverly Hills — a different part of town; rideshare assumed", "1 Hotel West Hollywood or Proper Santa Monica — boutique if that is the neighborhood"]);
    ...
    replaceHotel("nyc", "lux", ["Park Hyatt New York — Midtown flagship, only if you're spending more", "The Ritz-Carlton New York, Central Park — park-adjacent Stretch", "The St. Regis New York — Fifth Avenue, still a crosstown walk to meetings", "Conrad New York Downtown — Battery Park, not a Midtown tower", "1 Hotel Central Park — boutique flagship if that is the park address"]);
    ...
    replaceHotel("chicago", "lux", ["Park Hyatt Chicago — Water Tower Stretch", "The St. Regis Chicago — lakeshore tower, only if you're spending more", "Four Seasons Hotel Chicago — Mag Mile flagship", "Waldorf Astoria Chicago — Gold Coast, winter rates are the value window", "The Langham Chicago — river boutique-luxe if that is the address"]);
    ...
    replaceHotel("san_francisco", "lux", ["Fairmont San Francisco — Nob Hill, cable car at the door", "St. Regis San Francisco — SoMa, walk to SFMOMA", "Four Seasons Hotel San Francisco — SoMa flagship", "JW Marriott San Francisco Union Square — Stretch without a palace rate", "1 Hotel San Francisco — waterfront boutique if that is the Embarcadero"]);
    ...
    replaceHotel("san_diego", "lux", ["Hotel del Coronado — Hilton historic, ferry or bridge, the postcard lodging", "Fairmont Grand Del Mar — north, car assumed", "Pendry San Diego — harbor walk Stretch", "1 Hotel San Diego — waterfront boutique only if you're spending more", "Grand Hyatt San Diego — bay flagship if that is the tower, not Hotel Circle"]);
    ...
    replaceHotel("philadelphia", "lux", ["Four Seasons Hotel Philadelphia — Logan Square only if you're spending more", "The Logan Philadelphia — Marriott Autograph, Benjamin Franklin Parkway", "The Rittenhouse — square-adjacent Stretch", "W Philadelphia — Center City flagship", "Independence timed entry is the ticket, not a palace breakfast"]);
    ...
    replaceHotel("atlanta", "lux", ["Four Seasons Hotel Atlanta — Midtown only if you're spending more", "St. Regis Atlanta — Buckhead Stretch; you traded BeltLine walking", "Grand Hyatt Atlanta in Buckhead — same area, only if you're spending more", "JW Marriott Atlanta Buckhead — Stretch if that is Buckhead, not the Aquarium hotel", "The Whitley Atlanta Buckhead — Hyatt flagship, one tower"]);
    ...
    replaceHotel("dallas", "lux", ["The Ritz-Carlton, Dallas — Uptown only if you're spending more", "W Dallas Victory — Uptown / Victory Park Stretch", "The Joule — Downtown design flagship", "Hall Arts Hotel Dallas — Marriott Autograph, Arts District only if you're spending more", "Rosewood Mansion on Turtle Creek — only if you're spending more, car assumed"]);
    ...
    replaceHotel("seattle", "lux", ["Fairmont Olympic Hotel — Downtown historic only if you're spending more", "Four Seasons Hotel Seattle — waterfront Stretch", "Thompson Seattle — Hyatt, Belltown only if you're spending more", "W Seattle — Downtown flagship", "Lotte Hotel Seattle — Stretch if that is the tower, not every island ferry"]);
    ...
    replaceHotel("boston", "lux", ["Four Seasons Hotel Boston — Back Bay only if you're spending more", "The Newbury Boston — Fairmont-adjacent historic Stretch", "Mandarin Oriental, Boston — Boylston only if you're spending more", "Raffles Boston Back Bay — Stretch flagship", "The Langham, Boston — Financial District, February is cheap and icy"]);
    ...
    replaceHotel("washington_dc", "lux", ["Waldorf Astoria Washington DC — Pennsylvania Avenue only if you're spending more", "The Willard InterContinental — historic Stretch, walk to the Mall", "Conrad Washington DC — CityCenter, only if you're spending more", "St. Regis Washington, D.C. — Downtown flagship", "Four Seasons Hotel Washington, DC — Georgetown Stretch; you traded Mall walking"]);
    ...
    replaceHotel("london", "lux", ["The Savoy — Fairmont, river only if you're spending more", "Conrad London St. James — Stretch near Westminster", "The Langham, London — Portland Place only if you're spending more", "Raffles London at The OWO — Whitehall Stretch", "Claridge’s or The Connaught — Mayfair only if you're spending more"]);
    ...
    replaceHotel("paris", "lux", ["Park Hyatt Paris-Vendôme — 1st only if you're spending more", "Four Seasons Hotel George V — 8th Stretch", "The Ritz Paris — Place Vendôme, only if you're spending more", "Hôtel de Crillon — Rosewood, Place de la Concorde", "Lutetia Paris — Left Bank palace-adjacent if that is the name"]);
    replaceHotel("rome", "budget", ["Ibis Styles Roma Vintage or Ibis Roma Centro — Metro, pack light, stairs are common", "Holiday Inn Rome – Eur — Lean only if the budget is tight; Prati/Termini is closer", "Best Western Plus Hotel Universo — Termini, trains and buses, louder nights", "The Beehive — Termini hostel-plus if the party will share", "A Prati guesthouse near Ottaviano — Metro to the Vatican, calmer than the centro"]);
    ...
    replaceHotel("rome", "lux", ["Waldorf Astoria Rome Cavalieri — hill campus, only if you're spending more, a taxi to the centro", "The St. Regis Rome — Via Vittorio Emanuele Orlando Stretch", "Hotel de Russie — Rocco Forte, Piazza del Popolo, walk the centro", "Hassler Roma — Spanish Steps above the crush", "Hotel Eden — Dorchester, Via Veneto only if you're spending more"]);
    replaceHotel("tokyo", "budget", ["APA Hotel Shinjuku-Kabukicho or APA Guesthouse — station downstairs, convenience store in the lobby", "Toyoko Inn Shinjuku or Ueno — business-hotel Lean, skip a taxi habit", "Super Hotel Lohas Ikebukuro or Ueno — limited-service, Metro in the block", "Ibis Styles Tokyo Ginza — Accor value if you have room in the budget for a central ward", "Nine Hours capsule in Shinjuku — Lean crash-pad only, pack a cube"]);
    ...
    replaceHotel("tokyo", "lux", ["Park Hyatt Tokyo — Shinjuku, the view; you still take the Metro to dinner", "Conrad Tokyo — Shiodome Stretch", "The Ritz-Carlton, Tokyo — Roppongi only if you're spending more", "Aman Tokyo — Otemachi, station downstairs", "Palace Hotel Tokyo — Imperial-garden quiet, only if you're spending more"]);
    ...
    replaceHotel("maui", "budget", ["Holiday Inn Express Kahului — crash-pad only the night you fly; Lean lodging is a Kihei condo", "Maui Coast Hotel — Kihei, walk to a food truck, grocery the first hour", "Aston Maui Kamaole or a South Kihei studio — kitchen is the cheaper way", "Kohea Kai Maui — South Kihei boutique-value if the budget is tight", "Paia inn-adjacent 2-star — north shore if you will not sit in Kaanapali traffic"]);
    ...
    replaceHotel("maui", "lux", ["Grand Wailea, A Waldorf Astoria Resort — Wailea Beach, the Stretch default", "Andaz Maui at Wailea — Hyatt, same area, only if you're spending more", "Four Seasons Resort Maui at Wailea — only if you're spending more", "The Ritz-Carlton Maui, Kapalua — west side, a different drive", "Hotel Wailea — adults-only hill, you will still drive to dinner"]);
    ...
    replaceHotel("palm_springs", "lux", ["The Ritz-Carlton, Rancho Mirage — only if you're spending more, car assumed", "La Quinta Resort & Club, A Waldorf Astoria Resort — valley Stretch, a different drive than Downtown", "The Parker Palm Springs — only if you're spending more campus", "Omni Rancho Las Palmas — Rancho Mirage only if you're spending more", "Colony Palms Hotel — historic Stretch if that is the neighborhood"]);
    replaceHotel("napa", "budget", ["Hampton Inn & Suites Napa — limited-service, walk or a short hop to a grocery", "Holiday Inn Express Napa Valley — town Lean, skip an American Canyon highway motel unless you land late", "Napa Valley Marriott Hotel & Spa is mid; Lean stays Hampton / Express in Napa town", "A Calistoga value inn — walk to a grocery if Calistoga is the base", "Sonoma plaza-adjacent 2-star if Sonoma is the neighborhood you will eat in"]);
    ...
    replaceHotel("napa", "lux", ["Four Seasons Resort and Residences Napa Valley — Calistoga only if you're spending more", "Auberge du Soleil — Rutherford Stretch", "Solage, Auberge Resorts — Calistoga only if you're spending more", "Meadowood Napa Valley — Stretch if you have room in the budget", "The Estate Yountville — walk to dinner only if you're spending more; do not also buy every reserve tasting"]);
    ...
    replaceHotel("san_antonio", "lux", ["The St. Anthony Hotel — Marriott Autograph, Downtown grande dame only if you're spending more", "Thompson San Antonio — Pearl only if you're spending more", "Mokara Hotel & Spa — Destination by Hyatt, River Walk Stretch", "Fairmount Hotel San Antonio — historic Stretch, one property", "Hotel Emma Stretch suite if you have room in the budget for the jump from mid"]);
    ...
    replaceHotel("lake_tahoe", "lux", ["The Ritz-Carlton, Lake Tahoe — Northstar only if you're spending more", "Edgewood Tahoe Resort — South Shore Stretch", "The Village at Palisades Tahoe — Olympic Valley only if you're spending more", "One base. A second lodge is a transfer", "April and November are the mud-season discount"]);
    ...
    replaceHotel("monterey", "lux", ["L’Auberge Carmel — Relais, village only if you're spending more", "Bernardus Lodge & Spa — Carmel Valley Stretch", "Post Ranch Inn or Ventana Big Sur — only if you're spending more, Highway 1 closures happen", "One base in Monterey or Carmel — Big Sur plus both towns is three parking lots", "Check Highway 1 before you lock a Big Sur night"]);
    replaceHotel("destin_30a", "budget", ["Hampton Inn Destin — limited-service, grocery the first hour", "Holiday Inn Express Destin — Harbor-adjacent Lean, skip a high-rise you will Uber from to the beach", "A Destin 1-bedroom condo off 98 — kitchen is the cheaper way", "A 30A garage apartment in Seagrove or Santa Rosa if the budget is tight", "Miramar / Sandestin value only if you will use that beach"]);
    ...
    replaceHotel("destin_30a", "lux", ["WaterColor Inn & Resort — 30A only if you're spending more", "The Pearl Hotel Rosemary Beach — Stretch", "Hilton Sandestin Stretch suite if you have room in the budget for the gulf-front jump", "Henderson Park Inn — Destin only if you're spending more", "One town. Do not hop Rosemary, Seaside, and Destin nightly"]);
    replaceHotel("outer_banks", "budget", ["Hampton Inn & Suites Outer Banks / Corolla — north-end Lean only if that village is the plan", "Holiday Inn Express Nags Head — Lean corridor, grocery the first hour", "A Nags Head or Kill Devil Hills motel / 2-star — walk or a short drive to the sand", "A house share with a kitchen — the cheaper way if the party will cook", "Skip a Corolla oceanfront on Lean; the drive is longer and the rate is not"]);
    ...
    replaceHotel("outer_banks", "lux", ["The Sanderling Resort — Duck only if you're spending more", "A Corolla oceanfront house — Stretch if the party fills it", "Life House Nags Head — design oceanfront only if you're spending more", "One village", "Hurricane weeks are not a discount you want to win"]);
    ...
    replaceHotel("grand_canyon", "lux", ["El Tovar Hotel — rim flagship only if you're spending more", "Bright Angel historic cabin if El Tovar is sold", "A Tusayan 4-star is not Stretch if you wanted the rim at dawn", "One property. Phantom Ranch is a lottery, not a Stretch button", "January is quiet and cold — that is the value window"]);
    replaceHotel("jackson_hole", "budget", ["Hampton Inn Jackson Hole — town Lean, grocery the first hour", "Holiday Inn Express Jackson — limited-service, skip a ski-in marketing rate on Lean", "The Hostel (Teton Village) — ski-season Lean if the budget is tight", "49’er Inn or a Motel 6-class in town — the bus exists", "April and November are mud season — that is the discount"]);
    ...
    replaceHotel("phoenix", "lux", ["Arizona Biltmore, A Waldorf Astoria Resort — historic only if you're spending more, car assumed for dinner", "The Global Ambassador — Stretch", "JW Marriott Phoenix Desert Ridge Resort & Spa — north only if you're spending more, car assumed", "Winter weekends are peak; summer is the discount"]);
    ...
    replaceHotel("memphis", "lux", ["The Peabody Memphis — only if you're spending more if the ducks are the point", "Graduate Memphis Stretch suite", "Hu. Hotel suite only if you're spending more", "One property. East Memphis is a car commute", "Barbecue-fest weekends lift rooms"]);
    ...
    replaceHotel("bar_harbor", "lux", ["Claremont Hotel — Southwest Harbor only if you're spending more", "Asticou Inn — Northeast Harbor Stretch", "West Street Hotel suite only if you're spending more", "One property", "Cruise-ship mornings crowd the village — hike early"]);
    replaceHotel("santa_fe", "budget", ["Hampton Inn Santa Fe — limited-service, short drive or walk toward the Plaza", "Holiday Inn Express Santa Fe — Lean courtyard, grocery nearby", "Santa Fe Motel & Inn or El Rey Court — classic courtyards", "A Railyard 2-star if that is the food area", "Skip an airport-adjacent Albuquerque room as this lodging"]);
    ...
    replaceHotel("santa_fe", "lux", ["Four Seasons Resort Rancho Encantado — Tesuque Stretch, car assumed", "Inn of the Five Graces — only if you're spending more", "Bishop’s Lodge, Auberge Resorts Collection — only if you're spending more", "One property", "Late fall after Market is the value window"]);
    ...
    replaceHotel("denver", "lux", ["The Ritz-Carlton, Denver — Downtown only if you're spending more", "Four Seasons Hotel Denver — Stretch", "Hotel Teatro — Downtown flagship", "One tower. The mountains are a day trip, not a second hotel", "January is cheap and icy"]);
    replaceHotel("charleston", "budget", ["Hampton Inn Charleston – Historic District — limited-service, walk or a short hop to King", "Holiday Inn Charleston Historic Downtown — Lean, skip a North Charleston cloverleaf", "Courtyard Charleston Historic District — Marriott value", "A downtown 2-star a few blocks off the Battery tourist row", "An inn-adjacent guesthouse if the budget is tight"]);
    ...
    replaceHotel("charleston", "lux", ["The Restoration — only if you're spending more", "Planters Inn — Stretch", "The Spectator Hotel — only if you're spending more", "One property. Spoleto weeks lift rooms", "August is cheap and humid"]);
    ...
    replaceHotel("savannah", "lux", ["The Perry Lane Hotel — only if you're spending more", "JW Marriott Savannah Plant Riverside — Stretch", "The Gastonian or a Historic Stretch inn", "One property. St. Patrick’s week is a crowd tax", "January is the value window"]);
    replaceHotel("asheville", "budget", ["Hampton Inn Asheville Downtown — limited-service, walk or a short hop to downtown", "Holiday Inn Express Asheville Downtown — skip a tunnel-road motel plus nightly Ubers", "A Downtown 2-star or Foundry-adjacent compact room", "A West Asheville 2-star if that is the restaurant area", "Skip a Biltmore-gate hotel on Lean unless that is the trip"]);
    ...
    replaceHotel("austin", "lux", ["The Driskill — historic only if you're spending more", "Fairmont Austin Stretch suite", "Hotel Saint Cecilia — only if you're spending more", "W Austin — Downtown flagship", "SXSW / ACL weeks are not the value window"]);
    ...
    replaceHotel("nashville", "lux", ["The Hermitage Hotel — only if you're spending more", "Thompson Nashville — Hyatt Stretch", "Four Seasons Hotel Nashville — only if you're spending more", "Conrad Nashville — Stretch flagship", "January is the value window; bachelorette weekends lift rooms"]);
    replaceHotel("portland_oregon", "budget", ["Hampton Inn Portland Downtown Waterfront — limited-service, MAX, skip a Beaverton cloverleaf", "Holiday Inn Express Portland South — Lean only if the budget is tight; Downtown is the walk", "Courtyard Portland City Center — Marriott value, MAX / streetcar", "HI Portland — hostel-plus on MAX", "A Division 2-star if that is the food area — this is not Portland, Maine"]);
    ...
    replaceHotel("portland_oregon", "lux", ["The Nines — only if you're spending more", "Canopy by Hilton Portland Pearl District — Stretch", "The Ritz-Carlton, Portland — only if you're spending more", "One property. Do not also buy every food-cart crawl as a taxi loop", "January rain is the discount"]);
    ...
    replaceHotel("scottsdale", "lux", ["The Phoenician, a Luxury Collection Resort — only if you're spending more", "Four Seasons Resort Scottsdale at Troon North — only if you're spending more", "Sanctuary Camelback Mountain — only if you're spending more", "The Canyon Suites at The Phoenician — Stretch campus", "June rooms are cheap because the air hurts"]);
    replaceHotel("kauai", "budget", ["Hilton Garden Inn Kauai Wailua Bay — east-side Lean, grocery the first hour", "Holiday Inn Express Kauai — limited-service if the budget is tight", "A Kapaa 2-star or studio condo — kitchen beats resort breakfast", "A Poipu value condo a block off the sand", "Skip a North Shore rate on Lean; the drive is the hidden cost"]);
    ...
    replaceHotel("kauai", "lux", ["Grand Hyatt Kauai Resort & Spa — Poipu Stretch", "1 Hotel Hanalei Bay — North Shore only if you're spending more", "Koa Kea Hotel & Resort — Poipu only if you're spending more if Grand Hyatt is sold", "One shore. Do not also book every helicopter", "Na Pali is a boat or a hard hike, not both"]);
    replaceHotel("hawaii_big_island", "budget", ["Hampton Inn & Suites Kona — limited-service, grocery the first hour", "Holiday Inn Express Kailua-Kona — walk-adjacent Lean", "A Kailua-Kona 2-star or studio condo — kitchen is the cheaper way", "A Hilo 2-star only if volcano mornings are the point", "Skip a Kohala resort rate on Lean"]);
    ...
    replaceHotel("hawaii_big_island", "lux", ["Four Seasons Resort Hualalai — Kohala only if you're spending more", "Mauna Lani, Auberge Resorts Collection — Stretch", "Fairmont Orchid — Kohala only if you're spending more", "The Westin Hapuna Beach Resort — Hyatt-adjacent Stretch if that is the beach", "One campus. Do not also book every helicopter and snorkel"]);
    replaceHotel("yellowstone", "budget", ["Holiday Inn West Yellowstone — gateway Lean, grocery the first hour", "Hampton Inn West Yellowstone — limited-service if you have room in the budget for it", "A Gardiner 2-star if the north gate is the plan", "Old Faithful Lodge cabin class if you booked early", "Skip a Jackson hotel as this lodging"]);
    ...
    replaceHotel("yellowstone", "lux", ["Old Faithful Inn only if you're spending more — historic Stretch", "Lake Yellowstone Hotel Stretch suite", "One park base", "Do not also buy every snowcoach in summer", "Winter is a different product"]);
    ...
    replaceHotel("national_parks_southwest", "lux", ["Zion Lodge only if you're spending more — in-park if it exists and you booked months out", "Amangiri is a different budget", "A design desert Stretch in one gateway", "One base. Do not also buy every slot-canyon lottery as a sure thing", "Summer is brutally hot"]);
    ...
    replaceHotel("smoky_mountains", "lux", ["A luxury cabin only if you're spending more — one base", "The Park Vista Stretch suite", "LeConte Lodge is a hike lottery, not a Stretch button", "Do not also buy every show", "January is cheap and icy"]);
    ...
    replaceHotel("cancun", "lux", ["Hyatt Zilara Cancún — adults-only Hotel Zone", "Le Blanc Spa Resort Cancún — Stretch only if you have room in the budget", "JW Marriott Cancun Resort & Spa — Hotel Zone only if you're spending more", "Nizuc or Rosewood Mayakobá — south of the Zone; a different transfer", "One property. Two resorts in a week is a transfer tax"]);
    ...
    replaceHotel("punta_cana", "lux", ["Excellence Punta Cana or Secrets Cap Cana — adults-only only if you're spending more", "Eden Roc at Cap Cana — Stretch villa class", "Sanctuary Cap Cana — same area, not a second island hop", "Hyatt Zilara Cap Cana — adults-only Stretch", "One Cap Cana or Bávaro campus. A second resort hop is a transfer tax"]);
    ...
    replaceHotel("jamaica", "lux", ["Sandals South Coast or Sandals Montego Bay — couples AI only if you're spending more", "Hyatt Zilara Rose Hall — adults-only Stretch", "Round Hill Hotel and Villas — villa stretch, MoBay side", "Half Moon — Stretch, MoBay side", "Rockhouse or a Negril cliff boutique — only if you're spending more, not a fake rate"]);
    ...
    replaceHotel("cabo", "lux", ["Waldorf Astoria Los Cabos Pedregal — only if you're spending more", "The Cape, a Thompson Hotel — Hyatt Stretch", "Chileno Bay Resort & Residences, Auberge — only if you're spending more", "One property. Do not also buy every sunset sail", "September is cheap and humid"]);
    ...
    replaceHotel("aruba", "lux", ["Adults-only Palm Beach only if you're spending more — Hyatt or Hilton suite jump", "The Ritz-Carlton, Aruba — Stretch", "A villa Stretch — one resort", "Do not also buy every sunset sail", "September is cheap for a reason — heat, not storms"]);
    ...
    replaceHotel("bahamas", "lux", ["The Coral at Atlantis suite only if you're spending more", "Grand Hyatt Baha Mar Stretch", "Rosewood Baha Mar only if you're spending more", "One campus. The water park is a day-price", "Do not also buy every excursion"]);
    replaceHotel("turks_caicos", "budget", ["Sibonné or a Grace Bay 3-star garden view", "Coral Gardens class — walk to the sand", "A 2-star on Leeward if the budget is tight", "Skip a villa on Lean", "Confirm the transfer is in the rate"]);
    ...
    replaceHotel("turks_caicos", "lux", ["COMO Parrot Cay only if you're spending more", "Amanyara Stretch", "Grace Bay Club only if you're spending more", "One island", "Do not also buy every excursion"]);
    replaceHotel("tulum", "budget", ["Downtown Tulum 2-star or a hostel-plus — bike is the Lean car", "Aldea Zama limited-service — Holiday Inn-class if you find one", "A beach-road 3-star only if you have room in the budget for the jungle tax", "Skip a hotel-zone timeshare day", "Confirm the transfer"]);
    ...
    replaceHotel("tulum", "lux", ["Be Tulum or a beach-road Stretch only if you're spending more", "Azulik is a different product", "One property", "Do not also buy every cenote as a taxi loop", "Sargassum weeks are not a discount you want to win"]);
    replaceHotel("st_lucia", "budget", ["A Rodney Bay 3-star garden view — value, confirm the transfer", "Coconut Bay or a south-island value AI if the budget is tight", "A Castries 2-star only the night you fly", "Skip a piton-view suite on Lean", "The transfer is a mountain line"]);
    ...
    replaceHotel("st_lucia", "lux", ["Jade Mountain only if you're spending more", "Sugar Beach, A Viceroy Resort — Stretch", "Sandals Grande St. Lucian only if you're spending more", "One property", "Do not also buy every zip-line"]);
    ...
    replaceHotel("puerto_rico", "lux", ["Condado Vanderbilt only if you're spending more", "St. Regis Bahia Beach Resort — Stretch, car assumed", "Dorado Beach, A Ritz-Carlton Reserve — only if you're spending more", "One property", "Do not also buy every bioluminescent-bay tour as a sure night"]);
    ...
    replaceHotel("us_virgin_islands", "lux", ["Caneel Bay is a rebuild story — Stretch is a St. John villa only if you're spending more", "The Ritz-Carlton, St. Thomas — only if you're spending more", "One island", "Do not also buy every day-sail", "Hurricane weeks are not a discount you want to win"]);
    replaceHotel("amsterdam", "budget", ["Ibis Amsterdam Centre — tram to the canal belt, pack light", "Ibis Budget Amsterdam City South or Sloterdijk — tram to the center", "Holiday Inn Express Amsterdam – Sloterdijk — Lean if the budget is tight", "Generator Amsterdam or ClinkNOORD — hostel-plus, walk or ferry", "Hotel Not Hotel or a De Pijp 2-star — neighborhood, stairs are the elevator"]);
    ...
    replaceHotel("lisbon", "lux", ["Four Seasons Hotel Ritz Lisbon — park-adjacent only if you're spending more", "Bairro Alto Hotel — Chiado only if you're spending more", "Tivoli Avenida Liberdade Lisboa — one boulevard", "Olissippo Lapa Palace — Stretch", "Lisbon mid already feels like a Stretch in Paris"]);
    replaceHotel("prague", "budget", ["Ibis Praha Wenceslas Square — Metro, skip a castle-view rate on Lean", "Holiday Inn Prague Congress Centre — Metro Lean", "Moxy Prague — Marriott compact if you have room in the budget for a central area", "Generator Prague or a Vinohrady hostel-plus", "A 2-star walk-up near a tram and a bakery"]);
    ...
    replaceHotel("prague", "lux", ["Four Seasons Hotel Prague — river only if you're spending more", "Augustine, a Luxury Collection Hotel — Malá Strana Stretch", "Mandarin Oriental, Prague — only if you're spending more", "One flagship", "Christmas weeks lift rooms"]);
    replaceHotel("dublin", "budget", ["Ibis Dublin City Centre or Ibis Styles Dublin City Centre — walk or LUAS", "Holiday Inn Express Dublin City Centre — Lean, skip an airport hotel", "Generator Dublin — hostel-plus", "A Temple Bar-adjacent 2-star a block off the tourist row", "A Smithfield 2-star if that is the neighborhood"]);
    ...
    replaceHotel("dublin", "lux", ["The Merrion Hotel — only if you're spending more", "The Shelbourne, Autograph Collection — Stretch", "The Westbury — only if you're spending more", "One property", "Do not also buy every Guinness-and-castle stack"]);
    ...
    replaceHotel("edinburgh", "lux", ["The Balmoral only if you're spending more", "Waldorf Astoria Edinburgh - The Caledonian Stretch suite", "Gleneagles is a different trip", "One property", "August Festival is a crowd tax"]);
    ...
    replaceHotel("florence", "lux", ["Four Seasons Hotel Firenze — only if you're spending more", "Portrait Firenze — Stretch", "Hotel Savoy, a Rocco Forte Hotel — only if you're spending more", "One property", "Do not also buy every skip-the-line as a sure interior"]);
    replaceHotel("amalfi", "budget", ["Ibis Styles Sorrento if you base in Sorrento — stairs, pack light", "A Centro 2-star in Amalfi or Maiori — ferry or bus, not a car habit", "A Sorrento 3-star a block off the corso — stairs, pack light", "A Positano 2-star only if you have room in the budget; stairs are the elevator", "Skip a cliff suite on Lean"]);
    ...
    replaceHotel("amalfi", "lux", ["Hotel Santa Caterina — Amalfi only if you're spending more", "Le Sirenuse — Positano Stretch", "Belmond Hotel Caruso — Ravello only if you're spending more", "One village", "July–August is a crowd tax"]);
    ...
    replaceHotel("greece_athens", "lux", ["Hotel Grande Bretagne, a Luxury Collection Hotel — Syntagma only if you're spending more", "Hotel King George, a Luxury Collection Hotel — Stretch", "Four Seasons Astir Palace — coast only if you're spending more, a different commute", "One property", "Do not also buy every island hop as a sure day trip"]);
    ...
    replaceHotel("santorini", "lux", ["Canaves Oia only if you're spending more", "Mystique, a Luxury Collection Hotel — Stretch", "Grace Hotel Santorini, Auberge — only if you're spending more", "One village", "August is a crowd tax"]);
    replaceHotel("copenhagen", "budget", ["Ibis Copenhagen City or Ibis Styles Copenhagen — Metro, bakery downstairs", "Wakeup Copenhagen — compact Lean", "Generator Copenhagen — hostel-plus", "A Nørrebro 2-star if that is the restaurant area", "Skip an airport hotel as this lodging"]);
    ...
    replaceHotel("copenhagen", "lux", ["Hotel d'Angleterre — only if you're spending more", "Nimb Hotel — Stretch", "Villa Copenhagen — only if you're spending more", "One property", "Christmas weeks lift rooms"]);
    replaceHotel("vienna", "budget", ["Ibis Wien Mariahilf or Ibis Styles Wien City — U-Bahn, bakery downstairs", "Holiday Inn Express Vienna – Schönbrunn — Lean if the budget is tight", "A Neubau or Mariahilf 2-star — walk to a market street", "A hostel-plus near the Westbahnhof", "Skip an airport hotel as this lodging"]);
    ...
    replaceHotel("vienna", "lux", ["Hotel Sacher Wien — only if you're spending more", "The Ritz-Carlton, Vienna — Stretch", "Park Hyatt Vienna — only if you're spending more", "One property", "Ball season and Christmas weeks lift rooms"]);
    ...
    replaceHotel("stockholm", "lux", ["Grand Hôtel Stockholm — only if you're spending more", "Ett Hem — Stretch", "Nobis Hotel Stockholm — only if you're spending more", "One property", "Midsummer weeks are a plan, not a discount"]);
    ...
    replaceHotel("budapest", "lux", ["Four Seasons Hotel Gresham Palace — only if you're spending more", "The Ritz-Carlton, Budapest — Stretch", "Aria Hotel Budapest, a Tribute Portfolio Hotel — only if you're spending more", "One property", "Christmas weeks lift rooms"]);
    ...
    replaceHotel("iceland", "lux", ["The Reykjavik EDITION — 101 only if you're spending more", "The Retreat at Blue Lagoon — soak + room, Stretch only", "ION Adventure Hotel — Golden Circle only if you're spending more", "One 101 flagship or one countryside lodge — not both in 4 nights", "Luxury here is the soak, not the minibar"]);
    ...
    replaceHotel("switzerland", "lux", ["Baur au Lac only if you're spending more", "The Dolder Grand — Stretch", "Four Seasons Hotel des Bergues Geneva — only if you're spending more if Geneva is the base", "One property", "Do not also buy every mountain add-on"]);
    ...
    replaceHotel("croatia", "lux", ["Villa Dubrovnik only if you're spending more", "Hotel Bellevue Dubrovnik — Stretch", "One property", "Do not also buy every island hop", "July–August is a crowd tax"]);
    ...
    replaceHotel("spain_seville", "lux", ["Hotel Alfonso XIII, a Luxury Collection Hotel — only if you're spending more", "Hotel Palacio Villapanés — Stretch", "One property", "Feria and Easter weeks are a crowd tax", "July is cheap and brutal"]);
    ...
    replaceHotel("portugal_porto", "lux", ["The Yeatman only if you're spending more", "Pestana Palácio do Freixo — Stretch", "One property", "Do not also buy every cave tasting as a taxi loop", "São João weeks lift rooms"]);
    ...
    replaceHotel("portugal_algarve", "lux", ["Vila Vita Parc only if you're spending more", "Conrad Algarve — Stretch", "One property", "Do not also buy every boat cave as a sure day", "Winter is cheap because the water is a walk, not a swim"]);
    ...
    replaceHotel("norway_fjords", "lux", ["Hotel Ullensvang only if you're spending more", "A Loen or Geiranger Stretch lodge", "One property per base", "Do not also buy every scenic rail as a sure connection", "Shoulder weeks win"]);
    ...
    replaceHotel("mexico_city", "lux", ["Four Seasons Hotel Mexico City — Reforma only if you're spending more", "The St. Regis Mexico City — only if you're spending more", "Las Alcobas, a Luxury Collection Hotel — Polanco Stretch", "Casa Polanco — design only if you're spending more", "The reservation is often the better splurge than a second tower"]);
    replaceHotel("thailand", "budget", ["Ibis Bangkok Sukhumvit 4 or Ibis Styles Bangkok Sukhumvit Phra Khanong — BTS, not a taxi habit", "Holiday Inn Express Bangkok Siam — limited-service, BTS", "A Khao San-adjacent guesthouse only as a crash pad", "Lub d or a hostel-plus in Silom / Chiang Mai old city — walk to food stalls", "Fan room + a stall downstairs is the cheaper way"]);
    ...
    replaceHotel("thailand", "lux", ["Mandarin Oriental, Bangkok — river only if you're spending more", "Capella Bangkok — same river, Stretch", "Park Hyatt Bangkok — only if you're spending more", "Four Seasons Chiang Mai if the north is the point — do not also buy Phuket mid-trip", "One river hotel. Three island hops are a different budget"]);
    ...
    replaceHotel("kyoto", "lux", ["Four Seasons Hotel Kyoto — only if you're spending more", "The Ritz-Carlton, Kyoto — Stretch", "Park Hyatt Kyoto — only if you're spending more", "Hoshinoya Kyoto — river Stretch", "The room or the kaiseki, rarely both plus every temple taxi"]);
    ...
    replaceHotel("singapore", "lux", ["Marina Bay Sands only if you're spending more", "Raffles Singapore — Stretch", "The Fullerton Hotel Singapore — only if you're spending more", "Capella Singapore — Sentosa Stretch", "One property. Do not also buy every observation deck"]);
    ...
    replaceHotel("south_korea", "lux", ["Four Seasons Hotel Seoul — only if you're spending more", "Park Hyatt Seoul — Stretch", "The Shilla Seoul — only if you're spending more", "A hanok Stretch if that is the point", "The room or the BBQ, rarely both plus every palace as a sure interior"]);
    replaceHotel("taiwan", "budget", ["Ibis Taipei Daan or Ibis Styles Taipei Station — MRT", "Holiday Inn Express Taipei Zhonghua — limited-service", "A hostel-plus in Ximending", "A compact Taipei 2-star near a night market", "Skip a Tamsui rate on Lean unless that is the neighborhood"]);
    ...
    replaceHotel("taiwan", "lux", ["Mandarin Oriental, Taipei — only if you're spending more", "W Taipei — Stretch", "Grand Hyatt Taipei — only if you're spending more", "One property", "Do not also buy every day-trip as a sure connection"]);
    ...
    replaceHotel("vietnam", "lux", ["Park Hyatt Saigon only if you're spending more", "Capella Hanoi only if you're spending more", "Four Seasons The Nam Hai — Hoi An Stretch", "One property per base", "Do not also buy every lantern-boat as a sure night"]);
    ...
    replaceHotel("australia", "lux", ["Park Hyatt Sydney only if you're spending more", "Four Seasons Hotel Sydney — Stretch", "Crown Towers Melbourne only if you're spending more if Melbourne is the base", "One property", "Do not stack every harbour cruise and every zoo"]);
    replaceHotel("new_zealand", "budget", ["Ibis Wellington or Ibis Budget Auckland Airport — train / bus, skip a lakefront rate on Lean", "Crowne Plaza Auckland — IHG if you have room in the budget for a CBD Lean-plus night", "A Wellington 2-star on the waterfront bus", "A Queenstown hostel-plus if the south is the point", "Long-haul is the expensive line"]);
    ...
    replaceHotel("new_zealand", "lux", ["Hotel Britomart only if you're spending more", "Eichardt's Private Hotel — Queenstown Stretch", "One property per island base", "Do not also buy every adventure add-on", "Shoulder weeks win"]);
    ...
    replaceHotel("dubai", "lux", ["Armani Hotel Dubai — Burj Khalifa only if you're spending more", "Atlantis The Palm — Palm Stretch, kids assumed", "Bulgari Resort Dubai only if you're spending more", "Burj Al Arab or One&Only — name-brand only if you're spending more", "Dubai luxury is a weekend, not a week"]);
    ...
    replaceHotel("bali", "lux", ["Four Seasons Resort Bali at Sayan only if you're spending more", "Capella Ubud — Stretch", "Bulgari Resort Bali — cliff only if you're spending more", "Mandapa, a Ritz-Carlton Reserve — only if you're spending more", "One villa. Three mediocre resorts is not Stretch"]);
    ...
    replaceHotel("costa_rica", "lux", ["Nayara Tented Camp or Nayara Springs only if you're spending more", "Four Seasons Resort Costa Rica at Peninsula Papagayo — Stretch", "Andaz Costa Rica Resort at Peninsula Papagayo — Hyatt only if you're spending more", "One property per base", "Do not also buy every zip-line"]);
    ...
    replaceHotel("belize", "lux", ["Victoria House only if you're spending more", "Itz'ana or a Placencia Stretch", "One island or one coast", "Do not also buy every atoll as a sure day", "Hurricane weeks are not a discount you want to win"]);
    ...
    replaceHotel("guatemala", "lux", ["A Lake Atitlán Stretch lodge — one village only if you're spending more", "An Antigua courtyard only if you're spending more", "One property per base", "Do not also buy every volcano as a sure sunrise"]);
    ...
    replaceHotel("peru", "lux", ["Belmond Hotel Monasterio only if you're spending more", "Belmond Sanctuary Lodge — Machu Picchu Stretch", "Palacio del Inka, a Luxury Collection Hotel — Cusco only if you're spending more", "One property per altitude", "The ruin is the product, not a second suite"]);
    replaceHotel("peru_lima", "budget", ["Ibis Lima Reducto Miraflores — walk or a short hop to the malecón", "Holiday Inn Lima Airport — only the night you fly", "A Miraflores 2-star — grocery nearby", "A Barranco hostel-plus if that is the restaurant area", "Skip a cliff-view suite on Lean"]);
    ...
    replaceHotel("peru_lima", "lux", ["JW Marriott Hotel Lima only if you're spending more", "Hotel B — Barranco Stretch", "Belmond Miraflores Park only if you're spending more", "One area", "The tasting menu is often the better Stretch"]);
    replaceHotel("buenos_aires", "budget", ["Ibis Buenos Aires Congreso or Ibis Budget Recoleta — Subte, bakery downstairs", "Holiday Inn Buenos Aires Ezeiza Airport — only the night you fly", "A Palermo 2-star if that is the restaurant area", "A San Telmo hostel-plus — walk the Sunday fair", "Skip a Recoleta palace on Lean"]);
    ...
    replaceHotel("buenos_aires", "lux", ["Four Seasons Hotel Buenos Aires only if you're spending more", "Palacio Duhau - Park Hyatt Buenos Aires — Stretch", "Alvear Palace Hotel only if you're spending more", "One property", "The steakhouse is often the better Stretch than a second suite"]);
    replaceHotel("colombia", "budget", ["Ibis Cartagena Marbella or a Getsemaní 2-star — walk the walls, pack light", "A Centro hostel-plus — louder nights", "A Bocagrande 2-star if the budget is tight", "Skip a walled-city palace on Lean", "Confirm the transfer from the airport"]);
    ...
    replaceHotel("colombia", "lux", ["Sofitel Legend Santa Clara only if you're spending more", "Casa San Agustín Stretch", "One property", "Do not also buy every Rosario island as a sure day", "New Year weeks lift rooms"]);
    replaceHotel("colombia_medellin", "budget", ["Ibis Medellín or a Poblado 2-star — Metro, skip El Poblado palace on Lean", "A Laureles 2-star if that is the restaurant area", "A hostel-plus near a Metro stop", "Altitude slack is an activity", "Comuna 13 is a morning, not a hotel address"]);
    ...
    replaceHotel("colombia_medellin", "lux", ["The Charlee only if you're spending more", "A Poblado Stretch boutique", "One property", "Do not also buy every coffee tour as a sure day", "The tasting menu is often the better Stretch"]);
    replaceHotel("colombia_bogota", "budget", ["Ibis Bogotá Museo or a Candelaria-adjacent 2-star — walk, altitude slack", "Holiday Inn Bogotá Airport — only the night you fly", "A Chapinero 2-star if that is the restaurant area", "A hostel-plus near a TransMilenio stop", "Skip a Zona G palace on Lean"]);
    ...
    replaceHotel("colombia_bogota", "lux", ["Four Seasons Hotel Casa Medina Bogotá only if you're spending more", "Sofitel Bogotá Victoria Regia — Stretch", "One property", "Altitude plus street food is the trip", "The reservation is often the better Stretch"]);
    ...
    replaceHotel("brazil_rio", "lux", ["Belmond Copacabana Palace only if you're spending more", "Fairmont Rio de Janeiro Copacabana — Stretch", "Hotel Fasano Rio de Janeiro only if you're spending more", "One property", "Carnival weeks are not the value window"]);
    ...
    replaceHotel("panama", "lux", ["American Trade Hotel only if you're spending more", "The Bristol Panama — Stretch", "One property", "Do not also buy every island hop as a sure day", "The canal transit is a ticket, not a room upgrade"]);
    ...
    replaceHotel("mexico_oaxaca", "lux", ["Hacienda Los Laureles only if you're spending more", "A Centro Stretch courtyard", "One property", "The tasting menu is often the better Stretch", "Guelaguetza weeks lift rooms"]);
    ...
    replaceHotel("morocco", "lux", ["Royal Mansour Marrakech only if you're spending more", "La Mamounia Stretch", "Four Seasons Resort Marrakech only if you're spending more", "One property", "The riad or the desert camp — rarely both plus every souk guide"]);
    ...
    replaceHotel("south_africa", "lux", ["One&Only Cape Town only if you're spending more", "The Silo Hotel Stretch", "Belmond Mount Nelson only if you're spending more", "A safari lodge only if you're spending more is a different trip line", "The game drive is the product if you add the bush"]);
    ...
    replaceHotel("egypt", "lux", ["Four Seasons Hotel Cairo at Nile Plaza only if you're spending more", "Sofitel Legend Old Cataract Aswan Stretch", "A Nile cruise cabin is a different product only if you're spending more", "One property per city", "Do not also buy every optional tomb as a sure interior"]);
    ...
    replaceHotel("kenya_safari", "lux", ["Angama Mara only if you're spending more", "Giraffe Manor is a different product and waitlist", "A Stretch tented camp in one reserve", "One property", "Do not also buy every balloon as a sure dawn"]);
    ...
    replaceHotel("tanzania_zanzibar", "lux", ["andBeyond Mnemba only if you're spending more", "A Nungwi Stretch villa", "Park Hyatt Zanzibar suite only if you're spending more", "One property", "Do not also buy every spice tour as a sure day"]);
    ...
    replaceHotel("jordan", "lux", ["Four Seasons Hotel Amman only if you're spending more", "Mövenpick Nabatean Castle only if you're spending more", "A Wadi Rum Stretch camp", "One property per area", "Do not also buy every add-on tomb as a sure interior"]);
    ...
    replaceHotel("nepal", "lux", ["Dwarika's Hotel only if you're spending more", "A Pokhara Stretch lake lodge", "One property per base", "The trek is the product if you add it", "Do not also buy every scenic flight as a sure dawn"]);
    ...
    replaceHotel("cambodia", "lux", ["Raffles Grand Hotel d'Angkor only if you're spending more", "Park Hyatt Siem Reap Stretch", "One property", "Do not also buy every sunrise as a sure interior", "The temples still start early on Stretch"]);
    ...
    replaceHotel("philippines_palawan", "lux", ["El Nido Resorts Miniloc or Pangulasian only if you're spending more", "A Stretch island resort — one property", "Do not also buy every island hop", "Monsoon weeks are not a discount you want to win", "One base"]);
    ...
    replaceHotel("indonesia_lombok", "lux", ["The Oberoi Beach Resort, Lombok only if you're spending more", "A Gili Stretch villa", "One property", "Do not also buy every island hop", "One coast"]);
    ...
    replaceHotel("sri_lanka", "lux", ["Amangalla only if you're spending more", "Ceylon Tea Trails Stretch", "One property per area", "Do not also buy every safari as a sure dawn", "Monsoon coasts flip; pick the dry side"]);
    ...
    replaceHotel("italy_sicily", "lux", ["Belmond Grand Hotel Timeo only if you're spending more", "Four Seasons San Domenico Palace Taormina Stretch", "One property", "Do not also buy every ruin as a sure interior", "August is a crowd tax"]);
    ...
    replaceHotel("puerto_rico_rincon", "lux", ["A Rincón Stretch inn only if you're spending more", "Dorado Beach is the north coast — a different drive", "One property", "Do not also buy every sunset-sail", "Hurricane weeks are not a discount you want to win"]);
    ...
    replaceHotel("dominican_republic_samana", "lux", ["A Samaná Stretch villa only if you're spending more", "One property", "Do not also buy every whale trip as a sure dawn", "Cap Cana is a different island area", "One beach"]);
    replaceHotel("ecuador_galapagos", "budget", ["A Puerto Ayora 2-star — walk to the pier, grocery the first hour", "A hostel-plus on Santa Cruz", "Skip a yacht suite on Lean; land-based is the cheaper way", "Quito is a different lodging night and altitude", "Park fees are a line"]);
    ...
    replaceHotel("ecuador_galapagos", "lux", ["A small-ship cabin only if you're spending more — that is the Stretch product", "Finch Bay or a Stretch land lodge", "One ship or one lodge", "Do not also buy every extra island as a sure day", "The park rules are the itinerary"]);
    ...
    replaceFallbackHotel("asia", "budget", ["APA, Toyoko Inn, Super Hotel, or Ibis next to a Metro or JR station", "Holiday Inn Express or Fairfield when present — convenience-store breakfast", "Capsule only if you packed light", "Hostel-plus in the old city or night-market area", "Skip a palace-view rate on Lean"]);
    ...
    replaceFallbackHotel("latam", "lux", ["Four Seasons, Park Hyatt, or a casa-hotel only if you're spending more", "Adults-only beach premium", "Flagship in the centro or beach only if you're spending more", "The tasting menu is often the better Stretch", "One property"]);
