...
(function (global) {
  ...
  var PILOT = {
    disney: {
      ...
      blurb: "Match the resort to the parks. Skyliner for Studios and Epcot, the monorail if Magic Kingdom is the commute, and keep the dining plan off the card.",
      ...
      startHere: "Name the park days before the hotel. Hollywood Studios and Epcot point at Pop Century, Art of Animation, Caribbean Beach, or Riviera. A Magic Kingdom week is Grand Floridian, Contemporary, or Polynesian. Grocery the room after you land at MCO.",
      ...
      aroundKind: "fork",
      aroundRule: "On property you do not need a car to reach a park. Buses go to every gate. The Skyliner is a smaller map: Pop Century, Art of Animation, Caribbean Beach, Riviera, Hollywood Studios, and Epcot. The monorail is a third map, only from the Magic Kingdom Deluxe resorts. Magical Express is gone, so the ride from MCO is its own line. The calculator uses about $130 round trip for a family of four.",
      aroundNoCar: [
        ...
        "Mears or a rideshare from MCO. There is no airport bus in the rate anymore"
      ],
      aroundCar: [
      ...
      stayRule: "Buy the transportation, not the theme. Skyliner resorts earn the rate on Studios and Epcot weeks. Monorail Deluxe resorts earn theirs when Magic Kingdom is the morning. All-Star is the cheap bus, and it sits in a county with a higher lodging tax.",
      ...
      zones: [
        zone("Skyliner Value", "Pop Century and Art of Animation. The gondola reaches Hollywood Studios and Epcot. Magic Kingdom from either resort is a bus. Standard Pop rooms on an ordinary week sit around $150–250 before tax."),
        zone("All-Star bus", "Movies, Music, or Sports. The lowest on-property bed, commonly $140–220 before tax, and the resorts billed at Osceola County's 13.5% lodging tax rather than 12.5%."),
        zone("Moderate Skyliner", "Caribbean Beach, about $280–450 before Florida's 12.5% lodging tax. The campus is large. A room on the far side means an internal bus before you reach the gondola."),
        zone("Monorail loop", "Grand Floridian, Contemporary, or Polynesian, about $500–750. You are paying so Magic Kingdom is a walk, a boat, or the monorail."),
        zone("Off property", "International Drive can post a lower nightly rate, then adds a car, about $35 a day to park at the gate, and a shorter Lightning Lane booking window.")
      ],
      stayTiers: tiers(
        [
      ...
      book: [
        ...
        "The MCO transfer. Mears or rideshare, about $130 round trip for a family of four in the calculator. Magical Express does not exist."
      ],
      hidden: [
      ...
      tips: [
        ...
        "A Tuesday or Wednesday arrival at MCO is a different rate, on the same Pop or All-Star category, than Saturday of that week. Move the night before you move the resort."
      ],
      money: money(
    ...
    nyc: {
      ...
      blurb: "Sleep on a train you will ride. Price the room after 14.75% tax and any destination fee. One museum or one show, not three observation decks.",
      nights: "3–4 nights on one subway line",
      midrange: "Ace Hotel NoMad or The Hoxton, bodega breakfast, one sit-down",
      ...
      startHere: "Pick the train under the bed. Ace Hotel NoMad for the 6 and the N/R/W. citizenM Bowery for downtown. Pod 39 if a small Midtown room is truly what you want. The Hoxton Williamsburg if you will ride the L. Then buy the Met, MoMA, or one Broadway seat.",
      ...
      aroundKind: "transit",
      aroundRule: "You do not need a car. OMNY is $3 on the subway or a local bus. The same card or device caps at $35 after 12 paid local rides inside seven days, counted from your first tap, not from Monday. A Manhattan garage is often $50–80 a night before the tunnel.",
      aroundNoCar: [
        ...
        "The 7 train reaches Jackson Heights and Flushing on the same $3 fare as a ride to Times Square"
      ],
      ...
      eatRule: "Breakfast is a bodega or a bakery, $5–12. Three $28 Midtown salads are $84, which is a rush ticket. One sit-down in the neighborhood you slept in is the mid dinner. Wine is how that dinner leaves the $55–95 band.",
      ...
      zones: [
        zone("NoMad", "Ace Hotel NoMad, or Arlo NoMad if you want the room smaller. Walk to the 6 and the N/R/W. Mid rooms here run about $300–450 before the 14.75% tax. Dinner can stay in the neighborhood."),
        zone("Bowery and downtown", "citizenM Bowery, The Ludlow, or The Beekman if you are closer to the ferry. The F or the 6 is the commute. A downtown dinner does not need a car across town."),
        zone("Williamsburg", "The Hoxton, often $280–420 before tax, on the L. The rate wins until every dinner is in Manhattan after 11 p.m. and you stop being willing to ride back."),
        zone("Times Square, narrowly", "Pod 39 can make sense: a small room, about $180–280 before tax, with a train downstairs. A full-size tower with a destination fee is a billboard you will not watch."),
        zone("The park addresses", "1 Hotel Central Park, The Mark, or a Fifth Avenue flagship. Often $700 and up before tax. You bought the block. The subway is still $3.")
      ],
      stayTiers: tiers(
        [
        ...
        [
          ...
          "The Beekman — Downtown, FiDi, at the top of the mid band or just over it. Right if your days start at the ferry. A poor fit if every morning is MoMA: that is a long subway, which is fine, or a $25–40 rideshare, which spends the room.",
          "The Hoxton Williamsburg — Often $280–420 before tax, one river away. The L is quick to 14th Street. The mid tip fails when the curtain is at 8 and you have a second late table in the West Village. Those Ubers, $25–50 each, erase the discount.",
      ...
      eatTiers: tiers(
        [
          "A bodega egg-and-cheese — About $5–7, on the walk to the train. That is breakfast. The hotel dining room is a choice you should notice on the folio.",
          ...
          "Jackson Heights or Flushing on the 7 — Dinner that often lands $12–20 a person. Same $3 fare as Times Square. Do it once if the other meals have all been within two blocks of the hotel."
        ],
        [
        ...
        [
          "Le Bernardin — A prix fixe that often starts near $200 a person. One reservation. The next morning is a bodega, on purpose, not a second tasting.",
      ...
      doTiers: tiers(
        [
          "The Staten Island Ferry — $0. No ticket, no OMNY tap, day and night. Stand outside on the return toward Manhattan. This is the skyline.",
          ...
          "The High Line — $0 to enter. The cost is a Meatpacking meal you did not plan. Eat first. The walk itself does not have a toll.",
        ...
        [
          ...
          "Brooklyn Heights and Dumbo — The promenade is free. The A, C, or F to get there is $3. A rideshare across the East River is often $25–40 for the same view.",
      ...
      walk: {
        lead: "Two adults, three nights at Ace Hotel NoMad. This example has no destination fee. Bodega breakfast, one Village or NoMad dinner, six subway rides each, the Met, and one TKTS seat apiece. The OMNY cap does not trigger.",
        lines: [
          ...
          line("Food", "$450", "$75 a person, two people, three days. Inside $55–95: bodega mornings, one sit-down, no wine program."),
          line("OMNY", "$36", "$3 times six local rides times two people. The $35 cap needs 12 paid rides on the same card. This trip never gets there. You pay the rides."),
        ...
        trip: "About $1,976 before flights ($1,080 room + $159 tax + $11 unit fee + $450 food + $36 OMNY + $240 tickets). Lodging plus food before tax is $1,530, inside the Quick facts sample of $1,250–1,900. A destination fee, if the folio has one, adds $75–135 and is outside that sample.",
      ...
      days: [
        day("The neighborhood, then the ferry", [
          "Walk where you slept. From NoMad, go downtown on the 6. From Williamsburg, the L to Union Square, not a car across the river.",
        ...
        day("One museum, and stop", [
          ...
          "One lunch near the museum. The other meal that day is a slice at $3–5 or a bodega.",
          "Brooklyn Heights if you still want to be outside. The train is $3. A harbor cruise is usually the ferry with a chair."
        ]),
        day("A seat, or the 7", [
          "TKTS or rush if a show is why you came, often $80–120 after fees. Or dinner in Jackson Heights or Flushing, $12–20, on the 7.",
          "Do not add Summit and Edge because the afternoon looks empty. One deck is about $40. Zero decks is a finished day.",
          "Bodega in the morning. Hotel breakfast is the splurge you did not book, and at a flagship it can pass $40 a person."
        ])
      ],
      book: [
      ...
      skip: [
        ...
        skip("A Midtown lunch circuit", "Three $28 salads are $84. That is a rush ticket. One of those lunches should be a slice or a dinner on the 7.")
      ],
      tips: [
        "Hidden gem: OMNY caps at $35 after 12 local rides in seven days, on one card or phone, starting from the first tap. Two rides a day for three days never hits it. You owe $3 a ride. Do not buy an old unlimited MetroCard out of habit.",
        ...
        "Hidden gem: Jackson Heights and Flushing are a 7-train ride, $3, and a dinner that often runs $12–20 a person. Three Midtown salads cost more and stay in the same ten blocks.",
      ...
      money: money(
        "About $300–450 a night before tax, downtown, NoMad, or a Brooklyn train stop such as The Hoxton Williamsburg. Shoulder weeks in the 2026 tables sit nearer $300–420. Holiday weeks can run toward $580. The 14.75% tax is on top.",
        "About $55–95 with a bodega breakfast and one neighborhood dinner. Three $28 Midtown salads are the habit that leaves this band.",
    ...
    paris: {
      ...
      blurb: "Sleep on a Metro line in the 10th or 11th. TVA is already in the room quote. The taxe de séjour is not. Buy one museum, and do not buy a Monday–Sunday Navigo for a Wednesday arrival.",
      nights: "4 nights in one arrondissement",
      ...
      startHere: "Sleep in the 10th or 11th with the Metro at the corner and breakfast downstairs: Ibis at Gare du Nord or République, or a walk-up near Oberkampf. Choose the Louvre or the Orsay before you fly, on the museum's site. If the dinner is Septime, the reservation has to exist before the flight does.",
      tipsKicker: "The week pass starts Monday, even if your plane does not",
      cta: "Build the Paris Trip Plan in euros, from one arrondissement on the Metro. Add one museum. Add Septime only if you already hold the table.",
      forWho: [
      ...
      aroundKind: "transit",
      aroundRule: "You do not need a car. A single Metro or bus ride is about €2.50. Navigo Semaine for zones 1–5 is about €32 and runs Monday through Sunday. It is not seven rolling days from the morning you land. A rental based in the 10th is a parking problem.",
      aroundNoCar: [
        ...
        "Navigo Jour covers the day you will actually ride four times. On a museum day with two taps, single tickets may be the smaller number. Do the count before you buy the week",
        "Versailles is RER C and a half day. A Navigo may cover the train and still not cover the palace, about €21"
      ],
      ...
      eatRule: "A pastry and a coffee downstairs are about €4–7. A bouillon formule is about €20–30. One booked dinner is the mid week. A table facing the tower is a surcharge for a view Trocadéro already gives you.",
      doRule: "See the tower from Trocadéro for €0. Buy the Louvre or the Orsay from the museum. Since 14 January 2026 the Louvre is €32 for visitors from outside the EEA and €22 for EEA residents. A 2-day Museum Pass, about €60, loses if you only go through one door.",
      zones: [
        zone("10th, at the station", "Ibis Paris Gare du Nord, Metro downstairs, a bakery on the block. Rooms often €120–180 with TVA in the quote. You are not paying for a tower outside the window."),
        zone("11th, République to Oberkampf", "Ibis Styles or a walk-up, often €130–200. Canal Saint-Martin is a dinner walk. This base fails when every plan is a 9 a.m. Louvre and a Left Bank dinner: you will spend the savings in taxis."),
        zone("The canal, mid", "Hôtel Fabric or another Canal Saint-Martin boutique, about €190–280. The mid that is not a tower with a view of the tower."),
        zone("5th and 6th", "Hôtel Malte's side of town, or a 3-star near Odéon, about €200–320. Pay it when the days are the museums and a Left Bank table. Do not pay it and then cab to the canal every night."),
        zone("Palace addresses", "Hôtel de Crillon, Le Bristol, the Ritz, Cheval Blanc. Often €900 and up. Breakfast in the hotel is its own line. The corner bakery is still about €5.")
      ],
      stayTiers: tiers(
        [
          "Ibis Paris Gare du Nord — Metro at the door, often €120–180 with TVA already in the quote. You land and you sleep. A 7th-arrondissement room with a tower view, €80–150 more a night, is a different purchase.",
          "Ibis Styles Paris République — The 11th, about €130–190. Better if dinner is on the canal. Worse if you will not ride a Metro in the morning and intend to taxi to the Louvre every day at €15–25 a ride.",
          "Holiday Inn Express Paris Canal de la Villette — About €120–180, the night the CDG train gets you in late. It is an edge-of-the-canal bed. It is not a week in Saint-Germain. Stay on if the rest of the trip is actually up here.",
          "A walk-up near Oberkampf — A two-star, sometimes under the Ibis at €120–180, if you can live with stairs and a smaller room. The taxe de séjour is lower here than at a palace and it is still not zero. Budget a few euros a person per night on top of a rate that looked finished."
        ],
        [
          ...
          "Hôtel Malte — Or a Left Bank 3-star near Odéon, about €200–320, when the 5th or the 6th is the week you wanted. You are closer to the Louvre and the Orsay. Eat there. Commuting back to the 11th for a cheaper bistro spends the difference.",
          "Novotel Paris Les Halles — Central, about €200–300, useful for the Louvre and Châtelet. The failure is paying Les Halles money to face a shopping center when Fabric is the same band and a better walk to dinner.",
          "Hilton Paris Opera — One arrondissement for the whole stay, about €220–340. Stop splitting the week. A night by the Louvre and a night in Montmartre is two tax bills and a lost afternoon in between."
        ],
        [
      ...
      eatTiers: tiers(
        [
          "Du Pain et des Idées — If you are in the 10th. Coffee and a pastry, about €4–7. A palace breakfast is not a better croissant. It is a room-service price.",
          "Bouillon Chartier or Bouillon Pigalle — A formule, about €20–30 a person, noise included. This is the lunch that keeps Septime from becoming an idea you have every night.",
        ...
        [
          "Bouillon Julien — A step up from Chartier, about €25–40 a person. Still a formule, not a tasting menu, and still the right call on a night you do not hold a reservation.",
          "Marché des Enfants Rouges — Market lunch in the 3rd, about €12–20. Go hungry. Do not add a seated dinner the same afternoon because the market felt informal.",
          ...
          "A bistro in the 10th — One table near the hotel, about €35–55 a person. Wine by the glass keeps the day inside €30–55. A bottle apiece does not."
        ],
        [
      ...
      doTiers: tiers(
        [
          ...
          "Père Lachaise or the canal — €0 beyond the pastry, about €4–7. This is the evening that makes an 11th-arrondissement hotel the right hotel."
        ],
        [
          "The Louvre — €32 if you live outside the EEA, €22 if you are an EEA resident. Timed, on the museum's site, at the rates in force since 14 January 2026. A reseller bundle is often €20 more for the same door.",
        ...
        [
          ...
          "Versailles — The palace is about €21, plus RER C unless the Navigo you already hold covers the train. Give it the morning. It does not share an afternoon with the Louvre.",
      ...
      walk: {
        lead: "Two adults from outside the EEA. Four nights in the 11th or at a canal hotel. They arrive Monday, so a Navigo week matches the calendar. Bakery breakfast, one bistro inside the food band, and the Louvre. Orsay is not in this total. The planning rate used here is $1 ≈ €0.92.",
        lines: [
          ...
          line("Food", "€336", "€42 a person, two people, four days. Inside €30–55. Bakery mornings, a formule, one bistro. Not Septime."),
          line("Navigo", "€64", "Navigo Semaine, zones 1–5, about €32 × 2, because this example starts on Monday. Arrive Wednesday and skip it: eight rides at €2.50 is €20 a person, €40 for two."),
          line("Louvre", "€64", "€32 × 2 for visitors from outside the EEA. EEA residents pay €22 each, and this line would be €44. Buy it on the museum's site.")
        ],
      ...
      days: [
        day("The block, then the tower from the ground", [
          ...
          "Dinner in the arrondissement you slept in. A bouillon at €20–30 if you do not hold a table."
        ]),
        day("One museum, on its own site", [
          ...
          "Lunch is a formule or the market, €12–30. Not a second museum, and not the cafeteria as the plan.",
        ...
        day("Versailles, or a smaller ticket", [
          "If Versailles is the day, RER C in the morning and the palace at about €21. Be back before dinner. The Louvre is not this afternoon.",
      ...
      book: [
        "The Louvre (€22 for EEA residents, €32 for everyone else) or the Orsay (€16 online), on the museum's site, before you look at a bundle.",
        ...
        "Navigo Semaine, about €32 for zones 1–5, only when your dates are Monday through Sunday. Otherwise single rides at about €2.50, or a Navigo Jour on the day you will ride.",
      ...
      hidden: [
        ...
        "A tower-view room, often €80–150 a night above a 10th-arrondissement rate, for a view you can see from Trocadéro.",
        ...
        "Versailles at about €21 plus the RER, and a reseller's museum bundle, often €20 over the official price."
      ],
      skip: [
      ...
      tips: [
        ...
        "Versailles is a morning on RER C and about €21 at the palace. It does not fit after a Louvre opening. Give it the day or take it off the list."
      ],
      money: money(
        "About €190–330 a night for a mid hotel in the 10th, 11th, or on the Left Bank. That is the Trip Finder shoulder band of about $200–350, converted at roughly $1 ≈ €0.92. TVA is usually in the quote. The taxe de séjour is not.",
        "About €30–55 with a bakery breakfast, a formule, and one dinner. A Septime night at €80–120 is the exception, not the daily rate.",
        "The Louvre is €32 for visitors from outside the EEA and €22 for EEA residents. The Orsay is €16 online. A single museum beats a Museum Pass. The Metro is about €2.50, or about €32 for a Monday–Sunday Navigo in zones 1–5.",
