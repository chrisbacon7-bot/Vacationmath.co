...
(function (global) {
  ...
  var GUIDES = [
    G({
      ...
      stayProse: [
        "Pop Century and Art of Animation put Hollywood Studios and Epcot on a gondola. That's the cheaper way: food-court breakfast, bus to Magic Kingdom, and you never learn the I-4 exit numbers. All-Star is the same idea with a longer bus and a lower rate.",
      ...
      eatLead: "The dining plan is usually a bad buy — even on Stretch. Grocery the room, mobile-order lunch, one table-service if you have room in the budget.",
      eatProse: [
      ...
      doLead: "Hopper on a short trip usually costs more. A second park day is cheaper than switching after a $20 turkey leg.",
      doProse: [
      ...
      days: [
        ...
        { title: "Cheaper park or a rest day", body: "Animal Kingdom, a second single-park ticket, or Disney Springs plus a pool. Do not Hopper this unless you will switch after lunch on purpose. Memory Maker and the refillable mug are extras, not defaults." }
      ],
      base: {
      ...
      skip: [
        ...
        { name: "I-Drive hotel plus a rental as “Lean”", why: "You bought parking, gas, and a 40-minute commute. That's not a Budget stay." }
      ],
      ...
      tips: [
        ...
        "Memory Maker and the refillable mug only pay if you will actually use them every day. Price them as extras, not defaults.",
    ...
    G({
      ...
      stayLead: "Lean is a Harbor Blvd 3-star and a grocery bag. Pixar Place or Grand Californian only if you're spending more.",
      ...
      base: {
        ...
        stretch: "Grand Californian or Pixar Place if you have room in the budget. Still Anaheim, still no LA day stacked in."
      },
      ...
      whenTitle: "Smaller campus, same peak prices",
      ...
      whenNote: "Halloween and Christmas overlays are peak on purpose. Friday arrivals into those weeks cost more — you can see it from the parking garage.",
      ...
      tips: [
        ...
        "Midweek SNA or LAX flights. Friday arrivals into Halloween Time cost more.",
        ...
        "Pixar Place or Grand Californian only if you're spending more. Lean is Harbor Blvd and a grocery bag."
      ],
      related: [
    ...
    G({
      ...
      eatProse: [
        ...
        "Solid can do Republique, Langer’s, or Bestia if you booked ahead — still one neighborhood per night. Stretch is Providence or n/naka only if you're spending more — not a WeHo-to-Santa-Monica dinner transfer you will quote as “the city.”"
      ],
      ...
      base: {
        ...
        stretch: "Proper Santa Monica or Casa del Mar if the sand is the trip; 1 Hotel West Hollywood if that is the neighborhood. Still one neighborhood."
      },
      skipTitle: "Skip these",
      ...
      skip: [
        ...
        { name: "Dinner across town", why: "Don't drive across the city for dinner. A $40 rideshare each way is a second hotel night you already declined." }
      ],
      ...
      whenNote: "February is the value window for rooms. Summer weekends on the Westside mean parking and rates that cost more. Midweek flights into LAX, BUR, or SNA beat Friday arrivals.",
      ...
      tips: [
        ...
        "Midweek flights into LAX, BUR, or SNA. Friday arrivals cost more.",
    ...
    G({
      ...
      stayProse: [
        "Pod 39, Pod Times Square (if you must be near a train, not the neon), citizenM Bowery, Freehand, or a Queens/Brooklyn 2-star on a line. Small room. Walk to a swiper. That's the cheaper way.",
      ...
      eatLead: "Bodega egg-and-cheese. Jackson Heights, Flushing, or Chinatown at night. The hotel dining room is a Midtown salad with room-service prices.",
      eatProse: [
        ...
        "Dinner is one real sit-down in the borough you are already in. Via Carota wait, Lilia, or neighborhood Italian on Solid. Carbone or Le Bernardin class only if you're spending more — one tasting, not a tasting every night."
      ],
      ...
      days: [
        ...
        { title: "Ferry, or Broadway if you have room in the budget", body: "Staten Island Ferry in daylight, then a second neighborhood walk. Stretch spends the night on a reserved seat, not a third observatory. Go home on the train you already paid for." }
      ],
      base: {
      ...
      around: "Subway first. A Times Square address is how you overpay for neon. Outer-borough lodging on a train beats a Midtown west “deal.”",
      aroundBullets: [
      ...
      budgetNote: "Midtown “deals” plus resort-style fees are how NYC eats a Solid budget. Trip Plan uses a 14.75% lodging-tax assumption and the same hotel examples as this guide.",
      tips: [
        "Skip a Times Square hotel unless you like paying for the neon. Pod / citizenM / a Brooklyn train-stop room is Lean.",
        "Bodega egg-and-cheese or a bakery breakfast. The hotel dining room is a Midtown salad with room-service prices.",
    ...
    G({
      ...
      doLead: "Bellagio conservatory, a Fremont walk, one show if you have room in the budget. A nightclub table is Stretch, not mid.",
      base: {
    ...
    G({
      ...
      hook: "Ocean Drive menus are how you overpay. Cuban breakfast and a neighborhood dinner win the week.",
      ...
      doLead: "Skip bottle service on Lean. Everglades is a half-day only if you have room in the budget, not a default.",
      base: {
      ...
      budgetNote: "Ocean Drive addresses cost more for the same sand. Trip Plan uses a 13% lodging-tax assumption and the same Deco / Brickell examples as this guide.",
      tips: [
    ...
    G({
      ...
      stayTitle: "Transit-first. Union Square costs more.",
      ...
      tips: [
        ...
        "Union Square tourist hotels cost more. Embarcadero or a neighborhood 3-star is the Solid stay."
      ],
      related: [
    ...
    G({
      ...
      works: "You book Loop or River North limited-service so the L is a habit, not a project. Mag Mile hotels are for people who will not take the train. Winter is cold and honestly cheaper. Summer lakefront is the postcard and the premium. A suburban rate is parking you did not want.",
      ...
      around: "The L is the plan. A suburban rate is parking you did not want.",
      aroundBullets: [
    ...
    G({
      ...
      base: {
        ...
        stretch: "A Garden District or courtyard hotel if you have room in the budget — still cut before you cut Galatoire’s."
      },
      ...
      tips: [
        ...
        "Haunted tours only if you're spending more. Daylight Quarter walks and a streetcar hour are Lean."
      ],
      related: [
    ...
    G({
      ...
      works: "Center City or Old City puts the Bell, the Hall, and the Terminal in walking distance. An airport hotel is a SEPTA commute you will resent. Independence Hall is timed — book it. The cheesesteak argument is one lunch; roast pork at DiNic’s class is the local rebuttal.",
      ...
      base: {
        ...
        stretch: "A nicer Center City or Old City address. Zahav only if you're spending more — not a second hotel."
      },
      skipTitle: "Skip these",
      skip: [
        { name: "An airport hotel", why: "A SEPTA commute you will resent every morning." },
      ...
      around: "A cheap airport room is a commute you will resent. Walk Independence; ride to the rest.",
      aroundBullets: [
      ...
      tips: [
        ...
        "Stay Center City or Old City. An airport hotel is a SEPTA commute you will resent.",
        "Zahav only if you're spending more. Terminal leftovers plus one neighborhood Italian is Solid."
      ],
      related: [
    ...
    G({
      ...
      works: "MARTA from ATL, then Midtown or Ponce so the BeltLine Eastside is the evening. Downtown convention hotels are convention prices. Cumberland / Buckhead cloverleaf lodging on Lean is how you buy parking and a steakhouse you did not need. Check the convention calendar before you celebrate a “deal.”",
      ...
      budgetNote: "Atlanta’s combined lodging tax is high in this catalog (about 16.9%). Trip Plan already applies it. Midtown on MARTA is how Solid avoids Buckhead parking you did not want.",
      tips: [
    ...
    G({
      ...
      worksTitle: "Pick a neighborhood and a bakery",
      ...
      stayTitle: "A neighborhood you can walk in slippers",
      stayLead: "Ibis or a walk-up on a Metro line in the 10th, 11th, 18th, or 19th. A tower-block view is how you overpay.",
      stayProse: [
        ...
        "Solid is a Left Bank or Canal 3-star — Malte or Odeon-class, a Canal Saint-Martin boutique, Luxembourg or Bastille. One neighborhood. Stretch is Crillon / Cheval Blanc / Ritz / Bristol only if you're spending more. Lutetia-class Left Bank if you must have a name and still want to walk."
      ],
      ...
      eatProse: [
        ...
        "Solid reserves one 10th–11th table or Frenchie wine bar. Stretch is Septime, Frenchie, or Le Comptoir — book before you fly. Palace-hotel dining only if you're spending more."
      ],
      ...
      doProse: [
        ...
        "Solid: Louvre or Orsay, plus Sainte-Chapelle or a tower summit, not both. Marais or Latin Quarter in the evening. Stretch can add Versailles as a pricey half-day you accepted, or a Seine dinner cruise only if you're spending more — not a third museum."
      ],
      daysTitle: "Three days that stay in walking distance",
      daysLead: "One museum day. Two walking days. Dinner on your block.",
      days: [
        { title: "Your neighborhood, then the river", body: "Bakery crawl on the block. Île de la Cité / Left Bank walk. Eiffel from Trocadéro at dusk. Do not “do” the summit on night one, and do not eat on the steps." },
      ...
      base: {
        ...
        stretch: "Palace or palace-adjacent (Crillon, Bristol, Lutetia class) only if you're spending more. Paris mid already eats a US city budget."
      },
      ...
      whenGo: "Late January through March, and November before the holiday lights make rooms cost more.",
      ...
      aroundBullets: [
        ...
        "Walk one neighborhood in the morning. The tower is a Trocadéro view on Lean, not a summit default.",
        "CDG vs ORY: RER B is the honest CDG move. A taxi only if you're spending more, not Lean."
      ],
      ...
      tips: [
        ...
        "10th–11th or 18th–19th on a Metro line. A tower-block view is how you overpay."
      ],
      related: [
    ...
    G({
      ...
      works: "You tap a bank card, hit the daily cap, and sleep in Zone 1–2 on a line you will use. A rental car is how you buy the Congestion Charge on purpose. Free museums are the product. The Eye is a pick-one with the Tower — not both on Lean. Mayfair only if you're spending more; luxury is the room plus £8 pints.",
      stayTitle: "Zone 1–2 on a Tube line",
      stayLead: "Premier Inn or Travelodge on Lean. The Hoxton if you want restaurants on the block. Mayfair if you're spending more.",
      ...
      base: {
        ...
        stretch: "Savoy, The Ned, Claridge’s / Connaught — only if you're spending more. Covent Garden Hotel if you want theatre without a palace rate."
      },
      ...
      tips: [
        ...
        "Premier Inn or Travelodge Zone 1–2 on Lean. Mayfair only if you're spending more — luxury is the room plus £8 pints.",
    ...
    G({
      ...
      base: {
        ...
        stretch: "De Russie, Hassler / Eden, or Pantheon-adjacent 5-star — only if you're spending more. Rome mid plus one dinner often beats a palace room."
      },
      ...
      tips: [
        ...
        "Golf-cart forum tours only if you're spending more. Daylight centro walks are Lean.",
        ...
        "La Pergola only if you're spending more. Roscioli-adjacent or a Testaccio trattoria is Solid."
      ],
      related: [
        { href: "/guides/paris", label: "Paris money guide" },
        { href: "/big-trip", label: "The Big Trip" }
    ...
    G({
      ...
      budgetNote: "Tokyo Lean is a business hotel and konbini. Stretch is the room or the sushi counter — rarely both. Trip Plan uses Asia flight patterns and the same APA / Mitsui Garden / Aman examples as this guide.",
      tips: [
        ...
        "Conveyor sushi and ramen are Solid lunches. Book one sushi counter if you have room in the budget — before you land.",
    ...
    G({
      ...
      skip: [
        { name: "The timeshare-day “free” excursion", why: "A pricey half-day with a smile." },
      ...
      tips: [
        ...
        "Skip the timeshare-day “free” excursion. It is a pricey half-day.",
        ...
        "Garden view on purpose. Ocean-view and swim-up upsells only if you're spending more, not Lean."
      ],
      related: [
    ...
    G({
      ...
      base: {
        ...
        stretch: "Kahala or Ko Olina / Aulani if you have room in the budget + kids (car assumed), or Halekulani if you refuse to leave Waikiki."
      },
    ...
    G({
      ...
      base: {
        ...
        stretch: "Grand Wailea, Andaz, or Four Seasons in Wailea — only if you're spending more, and you will still drive to dinner."
      },
      ...
      budgetNote: "Maui Solid is a Kaanapali beach path plus a kitchen a few nights. Trip Plan uses Hawaii tax and the same Kihei / Sheraton / Grand Wailea examples as this guide.",
      tips: [
        ...
        "Mama’s Fish House only if you're spending more. The kitchen plus one casual plate is Solid."
      ],
      related: [
    ...
    G({
      ...
      eatLead: "Main dining room every night on Lean. One specialty night only if you have room in the budget. Room service is a backup, not breakfast.",
      ...
      tips: [
        ...
        "Main dining room every night on Lean. One specialty night only if you have room in the budget.",
    ...
    G({
      ...
      hook: "Mallory menus are how you overpay. Cuban breakfast, one named dinner, and sunset from the sidewalk.",
      ...
      stayLead: "A guesthouse you can walk from. Casa Marina only if you're spending more. Stock Island plus a cab is not Lean.",
      eatTitle: "Cuban breakfast. Mallory is how you overpay.",
      eatLead: "Cuban Coffee Queen or a ventanita. El Siboney or Garbo’s for Lean dinner. Blue Heaven early if you have room in the budget for the wait.",
      ...
      skip: [
        { name: "Mallory Square menus", why: "You overpay for the same sunset you can watch from the sidewalk." },
      ...
      tips: [
        "Cuban Coffee Queen or a ventanita breakfast. Mallory Square menus are how you overpay.",
        "Sunset from the sidewalk. Skip a paid pier ticket on Lean — the sun does the same work.",
        "El Siboney or Garbo’s for Lean dinner. Blue Heaven early if you have room in the budget for the wait.",
